...
- [66uptime](https://66uptime.com/) `⊘ Proprietary` - 66uptime is a self-hosted, easy to use uptime monitoring tool. Websites, ports, & IPs monitoring, along with custom built status pages, Cron job monitoring & Domain names tracker. Can be used for personal reasons & can be white labeled to start a SAAS. ([Demo](https://66uptime.com/demo)) `PHP/MySQL`
