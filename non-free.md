...
- [SurveyJS](https://surveyjs.io/) - Extensible JavaScript form builder libraries with integration for React, Angular, Vuejs, and jQuery. ([Demos](https://surveyjs.io/survey-creator/examples/free-nps-survey-template/reactjs), [Source Code](https://github.com/surveyjs/survey-creator)). `⊘ Proprietary` `JavaScript`
