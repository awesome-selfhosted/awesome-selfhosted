...
- [gScreen](https://photoslideshow.app/) - Shuffled slideshows across your Google Photos libraries, viewable on any device with a web browser. ([Demo](https://demo.photoslideshow.app)) `⊘ Proprietary` `Go`
