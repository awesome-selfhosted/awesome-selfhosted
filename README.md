...
- [oTranscribe](http://otranscribe.com/) - Free web app to take the pain out of transcribing recorded interviews. ([Demo](https://otranscribe.com/), [Source Code](https://github.com/oTranscribe/oTranscribe)) `MIT` `JavaScript`
