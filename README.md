...
- [PassCheck](https://passcheck.xyz/) - A web application featuring some handy password tools, including a password generator, strength checker and HaveIBeenPwned breach checker. ([Demo](https://passcheck.xyz), [Source Code](https://github.com/apacketofsweets/PassCheck)) `MIT` `JavaScript`
