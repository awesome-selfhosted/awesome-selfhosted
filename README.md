...
- [Tinode](https://github.com/tinode) - Instant messaging platform. Backend in Go. Clients: Swift iOS, Java Android, JS webapp, scriptable command line; chatbots. ([Server](https://github.com/tinode/chat), [Web Client](https://github.com/tinode/webapp)) - `GPL-3.0` `Go`
