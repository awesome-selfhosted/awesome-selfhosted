...
**[`^        back to top        ^`](#)**
  ...
  * [Classified-ads](http://katiska.org/classified-ads/) - Messaging app originally designed to replace usenet news - requires no server-side support due to P2P nature. Includes private messages, profile data, search and voip. ([Source Code](https://github.com/operatornormal/classified-ads)) `LGPLv2` `C++`
