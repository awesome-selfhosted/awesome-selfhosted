...
**[`^        back to top        ^`](#)**
  ...
  * [Monica](https://monicahq.com/) - Personal Relationship Manager - A new kind of CRM to organize interactions with your friends and family ([Source Code](https://github.com/monicahq/monica)) `AGPLv3` `PHP`
