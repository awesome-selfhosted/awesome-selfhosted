...
- [Jellyfin Discord Music Bot](https://github.com/manuel-rw/jellyfin-discord-music-bot) - Discord bot that streams music from your Jellyfin media server (fork of [KGT1](https://github.com/KGT1/jellyfin-discord-music-bot/)) `MIT` `Nodejs`
