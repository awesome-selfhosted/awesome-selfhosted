...
- [Servus](https://github.com/ibz/servus) - a simple CMS / blog engine and personal Nostr relay that is fully self-contained within one executable file `GPL-3.0` `Rust`
