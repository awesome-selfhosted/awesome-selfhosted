...
- [OhMyForms](https://ohmyform.com/) - Open source alternative to TypeForm, TellForm, or Google Forms. ([Source Code](https://github.com/ohmyform/ohmyform)) `AGPL-3.0` `Docker`
