...
- [Bonfire](https://bonfirenetworks.org/) - A thoughtful social network with some federation capabilities. ([Source Code](https://github.com/bonfire-networks/bonfire-app)) `AGPL-3.0` `Elixr`
