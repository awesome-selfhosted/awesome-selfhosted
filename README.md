...
- [Fussel](https://github.com/cbenning/fussel) - Fussel is a static photo gallery generator. Easily generate a reactive gallery and host the optimized static folder of assets. ([Source Code](https://github.com/cbenning/fussel)) `MIT` `Python` `Javascript`
