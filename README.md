...
- [IndiView](https://github.com/rolandosborne/IndiView) - iOS & Android app for instant messaging and sharing photos and videos; runs on the selfhosted Diatum Network, with [Docker](https://github.com/diatum-org/coredb) images provided. 
