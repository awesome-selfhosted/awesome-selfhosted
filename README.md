...
- [CodexDrake](https://codexdrake.codewithrodi.com/) - Modern, hackable, self-hosted search engine, ridiculously fast and efficient, allowing anonymity due to no data collection. ([Source Code](https://github.com/codewithrodi/CodexDrake/), [Demo](https://codexdrake.codewithrodi.com)) `MIT` `NodeJS/ReactJS`
