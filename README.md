...
### Custom
  ...
  * [Spreed WebRTC](https://www.spreed.me/) - WebRTC audio/video call and conferencing server and web client. ([Source Code](https://github.com/strukturag/spreed-webrtc)) `AGPLv3` `Go`
