...
* [W](https://bitbucket.org/wisemapping/wisemapping-open-source/src/develop/)[ise Mapping](https://www.wisemapping.com) \- A multi\-user mind mapping web application\. \([Source Code](https://bitbucket.org/wisemapping/), [Docker](https://hub.docker.com/r/wisemapping/wisemapping)) `Apache-2.0 Java (server-side) HTML5`
...
* [LanguageTool](https://languagetool.org) \- An open source version of Grammerly\, use the browser extension to check writing styles\, grammer and spelling in 25 differeng languages \([Source Code](https://github.com/languagetool-org/languagetool))<span class="colour" style="color:rgb(36, 41, 47)">`LGPL 2.1 Java`</span>
