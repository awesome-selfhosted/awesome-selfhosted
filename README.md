...
- [Opengist](https://github.com/thomiceli/opengist) - Self-hosted pastebin powered by Git, open-source alternative to Github Gist. ([Demo](https://opengist.thomice.li/all)) `AGPL-3.0` `Go/Nodejs`
