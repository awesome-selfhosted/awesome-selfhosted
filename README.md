...
## Bookmarks & Link Sharing
  ...
  * [No Fuss Bookmarks](http://nofussbm.herokuapp.com/signup.html) - A very simple (GPLv3) Python software and service to store bookmarks especially designed for hackers (that don't need fancy interfaces, but nice API); [source code]( https://github.com/mapio/nofussbm).
