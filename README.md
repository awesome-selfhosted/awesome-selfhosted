...
- [Cadmus](https://github.com/liamdemafelix/cadmus) - Cadmus is an extremely lightweight, flat-file blogging platform powered by Markdown. ([Source Code](https://github.com/liamdemafelix/cadmus)) `MIT` `PHP`
