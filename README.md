...
_Web Analytics_
  ...
  * [GoAccess](http://goaccess.io/) - Real-time web log analyzer and interactive viewerc that runs in a terminal. ([Source Code](https://github.com/allinurl/goaccess)) `GPLv2` `C`
...
Some [Groupware](#groupware) solutions also feature calendar/address book editing and synchronization.
  ...
  * [DAViCal](http://www.davical.org/) - A server for calendar sharing (CalDAV). ([Source Code](https://gitlab.com/davical-project/davical)) `MIT` `PHP`
   * [Kcaldav](https://kristaps.bsd.lv/kcaldav/) - is a simple, safe, and minimal CalDAV server depending only on [kcgi(3)](http://kristaps.bsd.lv/kcgi/), [SQLite](https://www.sqlite.org/), and [expat(3)](http://expat.sourceforge.net/). ([Source code](https://kristaps.bsd.lv/kcaldav/snapshots/kcaldav.tgz))  `ISC` `C`
