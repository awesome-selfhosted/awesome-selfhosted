...
- [Drift](https://drift.maxleiter.com) - A paste service similar to GitHub Gist with syntax highlighting and markdown rendering. ([Source Code](https://github.com/MaxLeiter/Drift)) `MIT` `Nodejs`
