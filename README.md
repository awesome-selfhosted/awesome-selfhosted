...
- [Fontsource](https://fontsource.org) - Self-host Open Source fonts in neatly bundled NPM packages. ([Source Code](https://github.com/fontsource/fontsource)) `MIT` `Typescript`
