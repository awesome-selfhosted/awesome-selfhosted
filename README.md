...
- [Resoto] (https://resoto.com) - Resoto is an open source cloud asset inventory. Write code that reacts to changes in your cloud infrastructure. Resoto helps you search infrastructure, generate reports, and automate tasks. ([Source Code](https://github.com/someengineering/resoto)) `Apache-2.0` `Python/Docker`
