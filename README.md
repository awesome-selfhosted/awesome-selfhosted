...
- [Medusa](https://medusa-commerce.com/) - Free open-source headless commerce engine for fast growing businesses. ([Demo](https://demo.medusa-commerce.com), [Source Code](https://github.com/medusajs/medusa)) `MIT` `Nodejs`
