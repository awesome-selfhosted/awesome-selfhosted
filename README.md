...
- [Bagisto](https://www.bagisto.com/) - Open source E-commerce framework based on Laravel and Vue, running packs lot of cool features like Multi-Inventory Sources, Tax, Categories, etc([Source Code](https://github.com/bagisto/bagisto)) `MIT` `PHP`
