...
- [Semantic Scuttle](https://github.com/lucanos/SemanticScuttle) - Self-Hosted Bookmark system with structured tags and collaborative tag descriptions. `GPL-2.0` `PHP`
