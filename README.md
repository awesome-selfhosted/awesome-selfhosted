...
- [Micro](https://github.com/micro/micro) - A distributed systems runtime for the cloud and beyond. A fully vertically integrated cloud-native development platform focused entirely on the developer experience. `Apache 2.0` `Go`
