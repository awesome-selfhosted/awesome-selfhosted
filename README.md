...
- [OpenRouteService](https://openrouteservice.org/) - Selfhosted route service with Directions, Isochrones, Time-Distance Matrix, Route Optimization, etc. ([Demo](https://openrouteservice.org/dev/#/api-docs/introduction), [Source Code](https://github.com/GIScience/openrouteservice)) `GPL-3.0` `Java`
