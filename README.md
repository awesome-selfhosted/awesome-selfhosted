...
- [Strapi](https://strapi.io/) - The most advanced open-source Content Management Framework to build powerful API with no effort. ([Demo](https://strapi.io/demo), [Source Code](https://github.com/strapi/strapi/)) `MIT` `Nodejs`
