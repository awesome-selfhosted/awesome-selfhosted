...
- [VanDAM](https://github.com/Floppy/van_dam) - Digital asset manager for 3d print files; STL, OBJ, 3MF and more. ([Source Code](https://github.com/Floppy/van_dam)) `MIT` `Ruby` 
