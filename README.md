...
- [Dovel](https://dovel.email) - SMTP mail server with a minimal web interface and simple configuration, can server multiple domains. ([Source Code](https://blmayer.dev/x/dovel)) `LGPL-3.0` `Go`
