...
- [Sorry Cypress](https://sorry-cypress.dev) - Alternative open-source dashboard for unlimited parallelization, recording and debugging of cypress tests. ([Demo](https://sorry-cypress-demo.herokuapp.com), [Source Code](https://github.com/sorry-cypress/sorry-cypress)) `MIT` `Typescript`
