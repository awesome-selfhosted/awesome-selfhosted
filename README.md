...
- [Lazylead](https://github.com/dgroup/lazylead) - Self-hosted application that allows you to manage routine, annoying tasks within the ticketing systems like JIRA, GitHub, Trello. `MIT` `Ruby`
