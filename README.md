...
- [EteSync Notes](https://www.etesync.com/get-apps/) - End-to-end encrypted and journaled note taking app with Markdown editor, using Etebase (EteSync) as storage back end. ([Source Code](https://github.com/etesync/etesync-notes/)) `GPL-3.0` `Python/Django`
