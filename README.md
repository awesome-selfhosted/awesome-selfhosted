...
- [Castopod](https://castopod.org) - A podcast management hosting platform that includes the latest podcast 2.0 standards, an automated Fediverse feed, analytics, an embeddable player, and more. [Source Code](https://code.podlibre.org/podlibre/castopod-host) `AGPL-3.0` `PHP`
