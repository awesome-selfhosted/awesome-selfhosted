...
- [Squidex] (http://squidex.io) - Headless CMS, based on MongoDB, CQRS and Event Sourcing. ([Source Code](https://github.com/Squidex/squidex)) ([Demo](http://cloud.squidex.io)) `MIT` `.NET`
