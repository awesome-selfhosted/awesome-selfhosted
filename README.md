...
- [Amnezia VPN](https://github.com/amnezia-vpn/desktop-client) - Amnezia is a VPN client with the key feature of deploying your own VPN server on your virtual server. `GPL-3.0` `C++/C`
