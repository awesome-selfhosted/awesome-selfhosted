...
- [Nextcloud Bookmarks](https://github.com/nextcloud/bookmarks) - Bookmarks app for Nextcloud. ([Clients](https://github.com/nextcloud/bookmarks#third-party-clients)) `AGPL` `PHP`
