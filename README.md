...
- [Weaviate](https://github.com/semi-technologies/weaviate) - A cloud-native, realtime vector search engine integrating scalable machine learning models (GraphQL and RESTful APIs). ([Docs](https://weaviate.io/developers/weaviate/current/), [Demos](https://github.com/semi-technologies/awesome-weaviate)) `BSD-3-Clause` `Go`
