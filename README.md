...
- [titra](https://titra.io/en/free-time-tracking-online/) - titra is an open source project time-tracking solution for freelancers and small teams. ([Demo](https://app.titra.io/try), [Source Code](https://github.com/kromitgmbh/titra)) `GPL-3.0` `JavaScript`
