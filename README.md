...
#### XMPP Servers
  ...
  * [aenigma](https://github.com/openspace42/aenigma) - The | state-of-the-art | secure-by-default | one-touch-deployed | XMPP server for everyone.  `LibreLicense` `Erlang [ejabberd]`
