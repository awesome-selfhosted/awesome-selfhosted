...
- [Void](https://github.com/josephernest/void) - Flat file CMS with pages + blog articles, in less than 100 lines of PHP code. ([Demo](https://gget.it/void/), [Source Code](https://github.com/josephernest/void)) `MIT` `PHP`
