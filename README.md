...
- [Emby](https://emby.media) - Emby Server is a personal media server with apps on just about every device. ([Source Code](https://github.com/MediaBrowser/Emby)) `GPL-2.0` `C#`
