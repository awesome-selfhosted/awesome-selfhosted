...
- [Fotrino](https://www.fotrino.com/) - Awesome photo gallery written in Python (flask) and the Quasar framework.  Early stage development. ([Source Code](https://github.com/michaelmolino)) `GPL-3.0` `Python`
