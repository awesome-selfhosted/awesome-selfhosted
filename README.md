...
- [Coolify](https://coolify.io/) - An open-source & self-hostable Heroku / Netlify alternative (and even more). ([Demo](https://demo.coolify.io/) [Source Code](https://github.com/coollabsio/coolify)) `Apache License 2.0` `TypeScript`
