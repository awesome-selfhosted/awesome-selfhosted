...
- [Snips](https://snips.ai/) - Decentralized, offline, on-device, and multi-lingual smart voice assistant AI platform powered by python libraries that parse sentences in natural language, and extract structured information. ([Source Code](https://github.com/snipsco/snips-nlu)) `Apache-2.0` `Python`
