...
**[`^        back to top        ^`](#)**
  ...
  * [Flox](https://github.com/devfake/flox) `⚠` - Self hosted Movie, Series and Anime watch list with a rating based on a 3-point system for good, medium and bad. ([Demo](http://80.240.132.120/flox-demo/public/)) `MIT` `PHP`
