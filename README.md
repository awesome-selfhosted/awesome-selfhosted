...
- [Freshlytics](https://github.com/sheshbabu/freshlytics/blob/master/docs/screenshots.md) - Privacy respecting, cookie free and low resource usage analytics platform. ([Source Code](https://github.com/sheshbabu/freshlytics)) `MIT` `TypeScript`
