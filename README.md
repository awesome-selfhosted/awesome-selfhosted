...
_Single-click/drag-n-drop upload_
  ...
  * [linx](https://github.com/andreimarcu/linx-server) - File sharing application and pastebin written in Go with API, auto-expiry, deletion keys, and web seed support
