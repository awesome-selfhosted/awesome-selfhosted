...
- [InspIRCd](https://www.inspircd.org/) - a modular IRC server written in C++ for Linux, BSD, Windows and macOS systems. ([Source Code](https://github.com/inspircd)) `GFDL-1.2-only` `C++`
