...
- [Polar Bookshelf](https://getpolarized.io/) - Polar is a personal knowledge repository for PDF and web content supporting incremental reading and document annotation ([Source Code](https://github.com/burtonator/polar-bookshelf)). `GPL` `JS` 
