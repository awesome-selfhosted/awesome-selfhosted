...
- [Digital-Currency](https://github.com/Icesofty/Digital-Currency#readme) - Create your own Self-Hosted Digital Currency. ([Demo](http://tonken.mooo.com/), [Source Code](https://github.com/Icesofty/Digital-Currency)) `GPL-3.0` `Nodejs`
