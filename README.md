...
*See also [Project Management](#project-management) and [Ticketing](#ticketing).*
  ...
  * [Tasks](https://github.com/m1guelpiedrafita/Tasks) - Simple tasks & notes manager written in PHP, jQuery and Bootstrap using a custom flat file database. ([Demo](http://projects.miguelpiedrafita.com/Tasks/) `MPLv2` `PHP`
