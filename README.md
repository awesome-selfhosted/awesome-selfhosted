...
- [Excludarr](https://github.com/haijeploeg/excludarr) - Excludarr can delete movies and TV shows from Radarr and Sonarr if the media is also available on one of the configured streaming providers (e.g. Netflix).  `MIT` `Python`
