...
- [Baserow](https://baserow.io/) - Open source self hosted online no-code database and Airtable alternative. ([Source Code](https://gitlab.com/bramw/baserow)) `MIT` `Python` `Node.js`
