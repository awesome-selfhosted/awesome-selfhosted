...
## Automation
  ...
  * [homebank-converter](https://github.com/Binnette/homebank-converter) - A web app to convert an export bank file to compatible Homebank csv. ([Source Code](https://github.com/Binnette/homebank-converter)) `AGPLv3` `HTML5`
