...
**[`^        back to top        ^`](#)**
  ...
  * [Yacy](http://yacy.net/en/index.html) - Peer based, decentralized search engine server. ([Demo](http://search.yacy.net/), [Source](https://github.com/yacy/yacy_search_server)) `GPLv2` `Java`
