...
- [Amnezia VPN](https://en.amnezia.org) - Amnezia is a VPN client with the key feature of deploying your own VPN server on your virtual server. ([Source Code](https://github.com/amnezia-vpn/desktop-client)) `GPL-3.0` `C++/C`
