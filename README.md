...
- [Kavita](https://kareadita.github.io/) - Cross-platform o
-  server and web reader with user management, ratings and reviews, and metatdata support. ([Source Code](https://github.com/Kareadita/Kavita)) `GPL-3.0` `.NET Core`
