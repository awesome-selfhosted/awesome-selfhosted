...
- [FireShare](https://github.com/rockmanvnx6/FireShare) - A full-stack, pub-sub, real-time secure file sharing system. ([Demo](https://auspham.dev/FireShare)) `Nodejs` `MIT`
...
- [Olaris](https://gitlab.com/olaris/olaris-server) - Olaris is an open-source, community driven, media manager and transcoding server. `GPL` `Go`
...
- [changedetection.io](https://github.com/dgtlmoon/changedetection.io) - Self-hosted tool for staying up-to-date with web-site content changes, encourages consuming new information _pro-actively_ (know when important websites have content changes) instead of _re-actively_ (being fed information from social media and others) ([Source Code](https://github.com/dgtlmoon/changedetection.io)) `Apache-2.0` `Docker/Python`
