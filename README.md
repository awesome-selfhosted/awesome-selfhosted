...
_Web Analytics_
  ...
  * [Rakam](https://rakam.io/) - Custom analytics platform that can integrate with any source (website, mobile app, IoT, you name it), enrich and store events in a data warehouse. Later on, you can run complex analytical queries on your data in real-time, visualize results and create custom dashboards. ([Source Code](https://github.com/rakam-io/rakam)) `Apache` `Java`
