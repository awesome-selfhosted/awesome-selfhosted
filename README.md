...
- [Pasty](https://github.com/Lukaesebrot/pasty) - A beautiful selfhosted code paste server with a lot useful features. ([Demo](https://p.kse.li), [Source Code](https://github.com/Lukaesebrot/pasty)) `MIT` `Go`
