...
*See also [Wikis](#wikis)*
  ...
  * [savepad](https://github.com/novavex/textpad) - A minimalist notepad based on notepad.cc. `PHP` `MIT`
  * [scri.ch](https://scri.ch/) - scri.ch is a minimal web app that lets you draw, share, and fork existing drawings. ([Source Code](https://github.com/lisezmoi/scri.ch)) `MIT` `PHP`
