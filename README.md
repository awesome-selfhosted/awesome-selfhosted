...
- [Resoto](https://resoto.com) - Resoto creates an inventory of your cloud, indexes resources, captures dependencies, and maps out your infrastructure in an intuitive [graph](https://resoto.com/docs/concepts/graph). The graph contains metrics for each [resource](https://resoto.com/docs/reference/data-models) ([Source Code](https://github.com/someengineering/resoto)) `Apache-2.0` `Python/Docker`
