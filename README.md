...
- [Tiledesk](https://tiledesk.com) - Self Hosted alternative to Intercom, Zendesk, Drift, Tawk.to and Tidio for Customer Service and Conversational Marketing. ([Source Code](https://github.com/Tiledesk/tiledesk)) `MIT` `Nodejs`
