...
- [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) `⚠` - Host containerized Minecraft servers using docker. Can host either vanilla or modded Minecraft. `Apache-2.0` `Docker/Shell`
