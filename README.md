...
### IDE/Tools
  ...
  * [Vagrant LAMP](https://github.com/axeloz/vagrant-lamp) - A fully-featured Vagrant virtual LAMP environment for local developments. ([Source Code](https://github.com/axeloz/vagrant-lamp)) `GPLv3` `Vagrant`  
