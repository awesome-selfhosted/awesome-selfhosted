...
- [zrok](https://zrok.io/) - Open source serveo/ngrok alternative. Geo-scale, next-generation sharing platform built on top of OpenZiti. ([Source Code](https://github.com/openziti/zrok)) `Apache-2.0` `Go`
