...
- [Kiwix](https://www.kiwix.org/en/) - Wherever you go, you can browse Wikipedia, read books from the Gutenberg Library, or watch TED talks and much more – even if you don’t have an Internet connection. ([Source Code](https://github.com/kiwix/kiwix-tools)) `GPL-3.0` `C++`
