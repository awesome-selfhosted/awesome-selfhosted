...
- [Dante Stories](https://github.com/michelson/dante-stories) - A self hosted Medium platform built with Ruby on Rails. ([Demo](https://dante-stories.herokuapp.com/), [Source Code](https://github.com/michelson/dante-stories)) `MIT` `Ruby`
