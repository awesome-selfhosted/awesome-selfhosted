...
**[`^        back to top        ^`](#)**
  ...
  * [DietPi](http://dietpi.com/) - Highly optimized extremely lightweight minimal Debian OS for single-board computers, which allows you to easily install and manage several services (via terminal UI) for selfhosting at home. ([Source Code](https://github.com/Fourdee/DietPi)) `GPLv2` `Shell`
