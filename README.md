...
## Money, Budgeting and Management
  ...
  * [Hospital Run](http://hospitalrun.io/) - Hospital Run is offline enabled hospital management software. ([Source Code (Frontend)](https://github.com/HospitalRun/hospitalrun-frontend), [Source Code (Backend)](https://github.com/HospitalRun/hospitalrun-server), [Demo](http://hospitalrun.io/demo/)) `GPLv3` `Nodejs/Ember`
