...
- [MousikóFídi](https://mousikofidi.info/) - MousikóFídi is a web application for streaming audio and video files from your personal collection. ([Source Code](https://git.sr.ht/~hristoast/mousikofidi/)) `GPL-3.0`
...
- [devshort](https://git.sr.ht/~rwa/devshort) - Simplest, private self-hosted shortlink service. `MIT`
