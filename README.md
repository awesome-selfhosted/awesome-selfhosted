...
- [KeyCat](https://keydotcat.github.io) - End-to-end password manager that allows easy sharing of credentials. Currently a website, with  browser extension and mobile app in the works. Compiled for windows, linux and osx, docker container also available. ([Source Code](https://github.com/keydotcat/keycatd)) `MIT` `Go`
