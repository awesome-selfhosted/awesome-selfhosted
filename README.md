...
- [Mixpost](https://mixpost.app/) - Self-hosted social media management software. An excellent alternative to Hootsuite, Buffer, and other social media tools ([Source Code](https://github.com/inovector/MixpostApp)) `MIT` `PHP/Docker`
