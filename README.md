...
- [OpenSpeedTest](https://github.com/openspeedtest/Speed-Test) - Pure HTML5 network performance estimation tool. [Source Code](https://github.com/openspeedtest/Speed-Test) `CC-BY-ND 3.0` `Docker`  
