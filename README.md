...
- [LiveKit](https://livekit.io/) - Modern, scalable WebRTC conferencing platform with client SDKs. ([Demo]([https://livekit.io/playground](https://github.com/livekit/livekit#live-demos)), [Source Code](https://github.com/livekit/livekit-server)) `Apache-2.0` `Go`
