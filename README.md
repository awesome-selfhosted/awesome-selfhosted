...
- [Crater](https://craterapp.com/) - Self-hosted invoice website / mobile app for freelancers & small businesses. ([Demo](https://demo.craterapp.com/), [Source Code](https://github.com/bytefury/crater)) `BSD-3-Clause-CraterApp.com` `PHP`
