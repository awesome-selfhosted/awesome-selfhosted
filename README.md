...
- [Jina](https://github.com/jina-ai/jina/) - Cloud-native neural search framework for any kind of data. ([Demo](https://github.com/jina-ai/jina/blob/master/.github/pages/hello-world.md)) `MIT` `Python`
