...
- [OpenRemote](https://openremote.io) - 100% Open Source IoT Platform including Asset manager, Flow and WHEN-THEN Rules, Data visualisation Dashboard, Edge Gateway and Consoles. ([Demo](https://demo.openremote.io/), [Source Code](https://github.com/openremote/openremote)) `AGPL-3.0` `Java`
