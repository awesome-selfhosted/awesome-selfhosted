...
## Personal Dashboards
  ...
  * [TagSpaces](http://www.tagspaces.org/) - TagSpaces is an open source personal data manager. It helps you organize files with tags on every platform. ([SourceCode](https://github.com/tagspaces/tagspaces)) `AGPLv3` `Javascript`
