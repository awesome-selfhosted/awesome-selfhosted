...
- [Jam](https://jamshelf.com/) - Jam is an open source alternative to Clubhouse, Twitter Spaces and similar audio spaces.. ([Source Code](https://github.com/jam-systems/jam)) `AGPL-3.0` `Javascript`
