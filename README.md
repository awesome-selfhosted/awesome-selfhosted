...
- [Novu](https://novu.co/) - Notification management simplified! The ultimate service for managing multi-channel notifications with a single API. ([Source Code](https://github.com/novuhq/novu)) `Typescript`
