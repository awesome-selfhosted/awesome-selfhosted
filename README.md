...
- [Papercrane](https://papercrane.onrender.com/) - This is a self-hosted writing app. Write your story in papercrane. Anywhere. Anytime. Anyway. ([Source Code](https://github.com/surzia/papercrane)) `GPL-3.0` `Go/React`
