...
## Feed Readers
  ...
  * [JARR](http://1pxsolidblack.pl/jarr-en.html) - JARR (which stands for Just Another RSS Reader) is a web-based news aggregator and reader. ([Demo](https://jarr.info/login?next=%2F), [Source Code(https://github.com/jaesivsm/JARR)]) `AGPLv3` `Python`
