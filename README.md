...
- [VoceChat](https://voce.chat) - Private social sphere like Slack/Discord written with Rust. Host anywhere, embed anywhere. VoceChat is for you. ([Source Code](https://github.com/privoce/vocechat-web)) `GPL-3.0` `Rust/Docker/React/Typescript`
