...
- [Ory](https://www.ory.sh/) - Ory is the largest open source community in the world for application security solving authentication, authorization, access control, implementing best-practice standards including OAuth 2.0, OIDC, Zero Trust, FIDO2 U2F, WebAuthn, TOTP, and more. ([Source Code](https://github.com/ory)) ` Apache-2.0` `Go`
