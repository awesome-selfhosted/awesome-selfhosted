...
- [Croodle](https://github.com/jelhan/croodle) - Croodle is an end-to-end encrypted web application to schedule a date or to do a poll on a any topic. ([Source Code](https://github.com/jelhan/croodle)) `MIT` `JavaScript`
