...
- [Simple NixOS Mailserver](https://github.com/r-raymond/nixos-mailserver) - A complete mailserver solution leveraging the Nix Ecosystem. ([Source Code](https://github.com/r-raymond/nixos-mailserver)) `GPL-3.0` `Nix`
