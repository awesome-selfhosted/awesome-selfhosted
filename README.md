...
- [Thredded](https://thredded.org) - Forums, feature-rich and simple. ([Demo](https://thredded.org/), [Source Code](https://github.com/thredded/thredded), [Ansible](https://github.com/thredded/thredded-ansible)) `MIT` `Ruby`
