...
- [EmulatorJS](https://emulatorjs.netlify.app/) - Self-hosted Javascript emulation for various system. ([Source Code](https://github.com/EmulatorJS/EmulatorJS)) ([Demo](https://emulatorjs.netlify.app/demo.html)) `GPL-3.0` `Nodejs`
