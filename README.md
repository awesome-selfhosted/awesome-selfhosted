...
- [Lynx](https://github.com/Lynx-Shortener/Lynx) - URL shortener with many functions such as multiple accounts, ShareX support and an attractive but simple interface. ([Demo](https://demo.jck.cx)) `MIT` `Vuejs/Nodejs/Docker`
