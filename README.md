...
- [GWI](https://blmayer.dev/x/gwi) - A simple web interface for git repositories written in Go, comes with git http protocol. ([Demo](https://git.derelict.garden/)) `GPL-3.0-or-later` `Go`
