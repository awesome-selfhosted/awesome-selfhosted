...
- [s3server](https://github.com/jessfraz/s3server) - Simple HTTP interface to index and browse files in a public S3 or Google Cloud Storage bucket. ([Demo](https://gifs.jessfraz.com/), [Source Code](https://github.com/jessfraz/s3server)) `MIT` `Go`
