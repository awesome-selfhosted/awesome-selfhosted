...
- [Send](https://gitlab.com/timvisee/send) - A file sharing experiment which allows you to send encrypted files to other users. `MPL-2.0` `Nodejs`
  -[Send Client](https://gitlab.com/timvisee/send/-/tree/master/android) - A android client for Send. `MPL-2.0` `NodeJs`
