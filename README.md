...
_Web Analytics_
  ...
  * [Rakam](https://rakam.io/) - Custom analytics platform that can integrate with any data source (website, mobile app, IoT, you name it), enrich and store events in a data warehouse. Later on, you can run complex analytical queries on your event data in real-time, visualize results and create custom dashboards. ([Source Code](https://github.com/rakam-io/rakam)) `Apache` `Java`
...
*See also [Project Management](#project-management) and [Ticketing](#ticketing).*
  ...
  * [Tasks](https://projects.miguelpiedrafita.com/Tasks/) - Simple tasks & notes manager written in PHP, jQuery and Bootstrap using a custom flat file database. ([Demo](https://demo.miguelpiedrafita.com/tasks/), ([Source Code](https://github.com/m1guelpiedrafita/tasks)) `MPLv2` `PHP`
