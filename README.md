...
- [Papermerge](http://www.papermerge.com) - Open Source Document Management system focused scanned documents (electronic archives). Features file browsing in similar way to dropbox/google drive. OCR, full text search, text overlay/selection. ([Source Code](https://gitlab.com/ciur/papermerge)) `Apache-2.0` `Python/Django`.
