...
- [LittleLink](https://github.com/sethcottle/littlelink/) - The original DIY Linktree alternative. A simplistic approach for links in bio with 100+ branded buttons. Host with GitHub Pages, self-host, one-click deploy, or use an awesome community fork with Docker. ([Demo](https://littlelink.io/), [Source Code](https://github.com/sethcottle/littlelink)) `MIT` `HTML/CSS`
