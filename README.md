...
- [Linkbucket](https://sr.ht/~avalos/linkbucket-go) - Free and open-source, web-based bookmark manager focused on simplicity and minimalism. It is written in Go and React and it is totally self-hostable. ([Demo](https://linkbucketgo.avalos.me)) `AGPL-3.0` `Go` `React`
