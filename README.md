...
## Maps & GPS
  ...
  * [Owntracks](http://owntracks.org/) - Self-hosted, opensource location tracking. ([Source code](https://github.com/owntracks)) `GPLv3`
...
## Polls and Events
  ...
  * Calagator - An event aggregator. ([Demo](http://calagator.org/), [Source code](https://github.com/calagator/calagator)) `MIT` `Ruby`
