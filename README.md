...
- [Ory](https://www.ory.sh/) - Ory is the largest open source community in the world for application security. Ory maintains security software solving authentication, authorization, access control, application network security, and delegation. Ory implements a variety of best-practice standards including OAuth 2.0 / OAuth 2.1, OpenID Connect, Zero Trust Networking, Google Zanzibar Policy Framework, FIDO2 U2F, WebAuthn, TOTP, and many more. ([Source Code](https://github.com/ory)) ` Apache-2.0` `Go`
