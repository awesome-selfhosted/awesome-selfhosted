...
- [Databag](https://github.com/balzack/databag) - Federated e2e messaging client for the web, iOS, and Android, supporting text, photos, video, and webrtc video and audio calls. ([Demo](https://databag.coredb.org/#/create)) `Apache-2.0` `Docker`
