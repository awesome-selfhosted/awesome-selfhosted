...
- [LunaSec](https://www.lunasec.io) - Database and SDKs for transparently encrypting sensitive data in your apps. Open Source alternative to VeryGoodSecurity and similar compliance services. ([Source Code](https://github.com/lunasec-io/lunasec)) `Apache-2.0` `Go/TypeScript`
