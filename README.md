...
**[`^        back to top        ^`](#)**
  ...
  * [Ubuntu One](https://insights.ubuntu.com/2015/08/10/ubuntu-one-file-syncing-code-open-sourced) - A file synchronization server. ([Source Code](https://launchpad.net/filesync-server)) `AGPLv3` `Python`
