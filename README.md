...
- [Airsonic Advanced](https://github.com/airsonic-advanced/airsonic-advanced/) - Open-source web-based media streamer and jukebox based on Airsonic, with several key performance and feature enhancements. ([Source Code](https://github.com/airsonic-advanced/airsonic-advanced/) `GPL-3.0` `Java`
