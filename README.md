...
- [GitJournal](https://gitjournal.io) - A mobile first notes app. Notes are stored in Markdown and are synced with any Git Repo. ([Source Code](https://github.com/GitJournal/GitJournal)) `AGPL` `Flutter`
