...
- [LibrePhotos](https://github.com/LibrePhotos/librephotos) - Self hosted Google Photos clone, with a slight focus on cool graphs. ([Source Code](https://github.com/LibrePhotos/librephotos)) `MIT` `Python`
