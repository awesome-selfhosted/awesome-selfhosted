...
- [Dify](https://dify.ai/) - Dify aims to enable developers (and even non-developers) to quickly build useful applications based on large language models, ensuring they are visual, operable, and improvable. ([Demo](https://udify.app/chat/F2Y4bKEWbuCb1FTC)), ([Source Code](https://github.com/langgenius/dify)) `MIT` `Python`
