...
#### Single-click/drag-n-drop upload
  ...
  * [PsiTransfer](https://github.com/psi-4ward/psitransfer) - Simple open source self-hosted file sharing solution with robust up-/download-resume and password protection. ([Demo](https://transfer.psi.cx/), [Source Code](https://github.com/psi-4ward/psitransfer)) `BSD` `Nodejs` `VueJS`
