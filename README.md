...
- [Micro](https://m3o.com) - A distributed systems runtime for the cloud and beyond. A fully vertically integrated cloud-native development platform focused entirely on the developer experience. ([Source Code](https://github.com/micro/micro)) `Apache 2.0` `Go`
