...
- [Urbit](https://urbit.org/) - Platform for decentralized network of personal servers, consisting of a pure single-function operating system (Arvo), an identity layer (Azimuth), and virtual machine (Vere). [Source Code](https://github.com/urbit/urbit) `MIT License` `Hoon/Nook/C` 
