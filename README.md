...
- [ILLA Cloud](https://www.illacloud.com/) - ILLA is an open source low-code platform alternative to Retool and Appsmith for developers to build internal tools in minutes. ([Demo](https://fast-try.illacloud.com/) [Source Code](https://github.com/illacloud/illa-builder)) `Apache-2.0` `Docker/Rust`
