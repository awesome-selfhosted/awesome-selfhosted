...
- [MicroBin](https://github.com/szabodanika/microbin) - Simple, performant, configurable, entirely self-contained Pastebin and URL shortener. ([Source Code](https://github.com/szabodanika/microbin)) `BSD-3-Clause` `Rust`
