...
- [Fathom Analytics](https://usefathom.com) - A simple and privacy-focused web analytics alternative to Google Analytics. ([Source Code](https://github.com/usefathom/fathom)) `MIT` `Go/JS`
