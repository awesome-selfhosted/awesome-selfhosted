...
- [t6 IoT](https://api.internetcollaboratif.info/) - Open-source IoT Platform to connect physical Objects to timeseries - data oriented and focused, Data Exploration. ([Demo](https://api.internetcollaboratif.info/#signup)), [Source Code](https://github.com/mathcoll/t6)) `GPL-3.0` `Nodejs`
