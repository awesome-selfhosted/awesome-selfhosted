...
- [Shlink](https://shlink.io) - URL shortener with REST API and command line interface. Includes official progressive web application and docker images. ([Source code](https://GitHub.com/shlinkio/shlink)) `MIT` `PHP`
