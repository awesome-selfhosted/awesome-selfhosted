...
**[`^        back to top        ^`](#)**
  ...
  * [LibreReader](https://savannah.nongnu.org/projects/libreread/) - Free(Libre) Ebook reader. ([Demo](http://demo.libreread.org/), [Source Code](https://savannah.nongnu.org/git/?group=libreread)) `GPLv3` `Go`
