...
- [WeeWX](http://weewx.com/) - Open source software for your weather station. ([Demo](http://weewx.com/showcase.html), [Source Code](https://github.com/weewx/weewx)) `GPL-3.0` `Python`
