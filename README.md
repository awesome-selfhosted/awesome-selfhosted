...
- [Stash](https://stashapp.cc) - A web-based library organizer and player for your porn stash, with auto-tagging and metadata scraping support. ([Source Code](https://github.com/stashapp/stash)) `AGPL-3.0` `Go`
