...
- [PixelFed](https://github.com/pixelfed/pixelfed) - Pixelfed is an open-source, federated platform alternate to Instagram. ([Demo](https://pixelfed.social)) `GNU GPLv3` `PHP\HTML\Vue`
