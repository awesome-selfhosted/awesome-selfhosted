...
- [Apache CloudStack](https://cloudstack.apache.org/) - Infrastructure as a Service (IaaS) cloud computing platform to deploy, orchestrate and manage virtual machines, volumes and networks. ([Quick Install Guide](http://docs.cloudstack.apache.org/en/latest/quickinstallationguide/qig.html)) `Apache-2.0` `Java`
