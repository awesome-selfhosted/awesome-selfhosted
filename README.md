...
## Groupware
  ...
  * [Tiki Suite](https://suite.tiki.org/tiki-index.php) - Tiki Suite is a FLOSS server, providing features to organisations such as: Email, Website & Blog, Shopping Cart, Intranet & Project Management, E-learning, Social Networking, Knowledge base, File sharing, Issue Tracker, Video-conferencing, LDAP, VPN. ([Demo](http://info.tiki.org/Demo)) `LGPLv2` `PHP` 
