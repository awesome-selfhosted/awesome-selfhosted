...
- [Searx](https://searx.github.io/searx/) `⚠` - Privacy-respecting, hackable metasearch engine. ([Demo](https://github.com/searx/searx-instances), [Source Code](https://github.com/searx/searx)) `AGPL-3.0` `Python`
