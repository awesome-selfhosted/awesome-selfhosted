...
See also [Static Site Generators](#static-site-generators), [Content Management Systems](#content-management-systems-cms) and [WeblogMatrix](http://www.weblogmatrix.org/)
  ...
  * [Solo](https://github.com/b3log/solo) - A blogging system written in Java, feel free to create your or your team own blog. ([Demo](http://88250.b3log.org/), [Source Code](https://github.com/b3log/solo)) `Apache` `Java`
...
**[`^        back to top        ^`](#)**
  ...
  * [Symphony](https://github.com/b3log/symphony) - A modern community (forum/SNS/blog) platform written in Java. ([Demo](https://hacpai.com), [Source Code](https://github.com/b3log/symphony)) `GPLv3` `Java`
