...
- [tine - Community Edition](https://github.com/tine20/tine20) - Contacts, Calendar, Tasks, WebDAV, ActiveSync, VoIP, Mail-Client, CRM, Sales, Projects, Timetracker. ([Install Howto](https://github.com/tine20/tine20/wiki/EN%3AInstall-Howto)) `AGPL-3.0` `PHP`
