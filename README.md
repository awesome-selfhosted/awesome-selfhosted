...
- [Firezone](https://www.firezone.dev/) - Self-hosted secure remote access gateway built on WireGuard with a Web GUI and support for MFA and SSO. ([Source Code](https://github.com/firezone/firezone)) `Apache-2.0` `Elixir`
