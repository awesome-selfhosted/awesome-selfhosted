...
- [FreeScout](https://github.com/freescout-helpdesk/freescout) - Open source clone of Help Scout: email-based customer support platform, help desk and shared mailbox. ([Source Code](https://github.com/freescout-helpdesk/freescout)) `AGPL-3.0` `PHP`
