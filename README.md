...
## Feed Readers
  ...
  * [FreshRSS](http://freshrss.org/) - A self-hostable RSS feed aggregator ([Demo](http://demo.freshrss.org/i/), [Source code](https://github.com/FreshRSS/FreshRSS)) - `AGPLv3`
    * [EasyRSS](https://github.com/Alkarex/EasyRSS) - A mobile application compatible with FreshRSS
