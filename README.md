...
- [simple-dash](https://github.com/Swagielka/simple-dash) - A simple, fully responsive Dashboard to forward to the services of your choice! ([Demo](http://simple-dash-demo.bplaced.net/), [Source Code](https://github.com/Swagielka/simple-dash)) `MIT` `PHP` 
