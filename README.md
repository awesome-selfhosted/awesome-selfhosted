 ...
 * [Hapttic](https://github.com/jsoendermann/hapttic) - Hapttic is a simple HTTP server that forwards all requests to a shell script to handle webhooks you receive. `Apache` `Go`
