...
- [Lila](https://lichess.org/) - The forever free, adless and open source chess server, with official iOS and Android client apps. ([Source Code](https://github.com/ornicar/lila)) `AGPL-3.0-or-later` `Scala`
