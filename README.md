...
- [VoceChat](https://voce.chat) - Private social sphere like Slack/Discord written with Rust. 15MB server to be hosted anywhere, embeded anywhere. VoceChat is for you. ([Source Code](https://github.com/privoce/vocechat-web)) `GPL-3.0` `Docker` `Shell` 
