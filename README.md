...
- [KatBin](https://github.com/sphericalkat/katbin-elixir) - Small, lightweight pastebin and URL shortener written in Elixir. ([Demo](https://katb.in/), [Source Code](https://github.com/sphericalkat/katbin-elixir)) `MIT` `Elixer`
