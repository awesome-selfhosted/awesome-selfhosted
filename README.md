...
- [Publii](https://getpublii.com/) - GUI based blogging platform that works on Linux, Mac, and Windows. Easy to use with templates, multi-site management, and multiple options for site syncing. Manage sites using FTP, SFTP, AWS, Github Pages, Gitlab, Netlify, Google Cloud, or you can publish you flat-files to a zip file. ([Source code](https://github.com/GetPublii/Publii)) `GPL-3.0` `Vue`
