...
- [µStreamer](https://pikvm.org) - µStreamer is a lightweight and very quick server to stream MJPEG video from any V4L2 device to the net. ([Source Code](https://github.com/pikvm/ustreamer)) `GPL-3.0` `C`
