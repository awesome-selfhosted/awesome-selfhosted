...
- [Memories for NextCloud](https://github.com/pulsejet/memories) - Batteries-included photo management solution for Nextcloud. ([Demo](https://memories-demo.radialapps.com/apps/memories/)) `AGPL-3.0` `Vue/PHP/TypeScript`
