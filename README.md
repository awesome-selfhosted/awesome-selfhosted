...
- [DNS-over-HTTPS](https://github.com/m13253/dns-over-https) - Client and server software to query DNS over HTTPS, using Google DNS-over-HTTPS protocol and IETF DNS-over-HTTPS (RFC 8484). `MIT` `Go`
