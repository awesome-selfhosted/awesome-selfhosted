...
- [GlitchTip](https://glitchtip.com) - GlitchTip's open source platform makes monitoring software easy. Track errors, monitor performance, and check site uptime all in one place. ([Source Code](https://gitlab.com/glitchtip/glitchtip)) `MIT` `Python`
