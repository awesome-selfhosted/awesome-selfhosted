...
- [PhoneTrack](https://gitlab.com/eneiluj/phonetrack-oc) - Nextcloud app to create tracking sessions to display phones position in real time and export activity to gpx. `AGPL-3.0` `JS`
