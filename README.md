...
- [OpenClaw](https://openclaw.ai/) - Free and open-source self-hosted AI agent with persistent memory, MCP support, 50+ integrations, and 12+ messaging platforms. ([Source Code](https://github.com/openclaw/openclaw)) `MIT` `Nodejs/Docker`
