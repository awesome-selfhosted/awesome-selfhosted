...
- [linky](https://gitlab.com/dtjm/linky) - Bookmarking and archiving backed by a single SQLite file (bring your own sync). Supports full-text search (including PDF content). 
