...
- [Karaoke Forever](https://www.karaoke-forever.com) - Open karaoke party system where everyone can easily find and queue songs from their phone’s web browser. The player is also browser-based, supporting [MP3+G](https://en.wikipedia.org/wiki/MP3%2BG) (with WebGL visualizations) and MP4 files. ([Source Code](https://github.com/bhj/karaoke-forever)) `ISC` `JavaScript`
