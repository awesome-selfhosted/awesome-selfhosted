...
- [OpenMapTiles](https://openmaptiles.org/) - Set of tools for self-hosting of OpenStreetMap vector tiles. ([Demo](https://openmaptiles.org/), [Source Code](https://github.com/openmaptiles)) `MIT` `Python/JavaScript`
