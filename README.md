...
**[`^        back to top        ^`](#)**
  ...
  * [OwnTracks](http://owntracks.org/) `⚠` - Location tracking for Android and iOS, embedded devices, and home automation. ([Source Code](https://github.com/owntracks/recorder)) `GPLv2` `C`/`Lua`
