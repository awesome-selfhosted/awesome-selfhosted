...
- [MiroTalk P2P](https://p2p.mirotalk.com) - WebRTC P2P - simple, secure, fast real-time video conferences compatible with all browsers and platforms. ([Demo](https://p2p.mirotalk.com/newcall), [Source Code](https://github.com/miroslavpejic85/mirotalk)) `AGPL-3.0` `JavaScript`
- [MiroTalk SFU](https://sfu.mirotalk.com) - WebRTC SFU - simple, secure, scalable real-time video conferences compatible with all browsers and platforms. ([Demo](https://sfu.mirotalk.com/newroom), [Source Code](https://github.com/miroslavpejic85/mirotalksfu)) `AGPL-3.0` `JavaScript`
