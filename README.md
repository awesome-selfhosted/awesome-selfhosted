...
_Web Analytics_
  ...
  * [GoAccess](https://goaccess.io/) - Real-time web log analyzer and interactive viewer that runs in a terminal. ([Source Code](https://github.com/allinurl/goaccess)) `GPLv2` `C`
  ...
  * [Serposcope](https://serposcope.serphacker.com/en/) - Serposcope is a free and open-source rank tracker to monitor websites ranking in Google and improve your SEO performances. ([Source Code](https://github.com/serphacker/serposcope)) `MIT` `Java`
  * [Snowplow](https://snowplowanalytics.com/) - Have every single event, from your websites, mobile apps, desktop applications and server-side systems, stored in your own data warehouse and available to action in real-time. ([Source Code](https://github.com/snowplow/)) `Apache` `Scala`
...
_Business Intelligence_
  ...
  * [Redash](https://redash.io/) - connect to over 18 types of databases (SQL and "NoSQL"), query your data, visualize it and create dashboards. Everything has a URL that can be shared. Slack and HipChat integration. ([Demo](https://demo.redash.io/login?next=https%3A%2F%2Fdemo.redash.io%2F), [Source Code](https://github.com/getredash/redash)) `BSD` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [Medusa](https://github.com/pymedusa/Medusa) - Automatic Video Library Manager for TV Shows. It watches for new episodes of your favorite shows, and when they are posted it does its magic. `GPLv3` `Python`
  * [Node RED](https://nodered.org/) - A browser-based flow editor that helps you wiring hardware devices, APIs and online services to create IoT solutions. ([Source Code](https://github.com/node-red/node-red)) `Apache` `Nodejs`
  * [openHAB](http://www.openhab.org) - Vendor and technology agnostic open source software for home automation. ([Source Code](https://github.com/openhab/openhab1-addons)) `EPLv1` `Java`
  * [Poffer](https://poffer.gabinaureche.com/) `⚠` - A tool that makes it easier to share the content you like thanks to Pocket+Buffer. ([Source Code](https://github.com/Zhouzi/Poffer)) `MIT` `Nodejs`
  ...
  * [RSS-Bridge](https://github.com/RSS-Bridge/rss-bridge) - rss-bridge is a PHP project capable of generating ATOM feeds for websites which don't have one. `Public domain` `PHP`
  ...
  * [TriggerHappy](https://trigger-happy.eu/) - An opensource clone of IFTTT, a bridge between your internet services. ([Source Code](https://github.com/foxmask/django-th)) `BSD` `Python`
  ...
  * [WTFDYUM](https://github.com/jchampemont/WTFDYUM) `⚠` - Why The Fuck Did You Unfollow Me - Find out who stops following you on Twitter. ([Demo](https://wtfdyu.me:443/), [Source Code](https://github.com/jchampemont/WTFDYUM)) `Apache` `Java`
...
See also [Static Site Generators](#static-site-generators), [Content Management Systems](#content-management-systems-cms) and [WeblogMatrix](http://www.weblogmatrix.org/)
  ...
  * [Blogotext](https://lehollandaisvolant.net/blogotext/) - A free blog-engine written in PHP and using SQLite. This offers you both an unmatched simplicity during installation and great performances. ([Source Code](https://github.com/BlogoText/blogotext)) `MIT` `PHP`
  ...
  * [Known](https://withknown.com/) - A single website for all your content. ([Source Code](https://github.com/idno/Known)) `Apache` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Firefox Auth Server](https://mozilla-services.readthedocs.io/howtos/run-fxa.html) - This project implements the core server-side API for Firefox Accounts. ([Source Code](https://github.com/mozilla/fxa-auth-server/)) `MPLv2` `Nodejs`
   ...
   * [Firefox Sync Server](https://mozilla-services.readthedocs.io/howtos/run-sync-1.5.html) - Sync Firefox bookmarks, passwords, history, tabs, preferences. ([Source Code](https://github.com/mozilla-services/syncserver)) `MPLv2` `Python`
  ...
  * [unmark](https://unmark.it/) - An open source to do app for links. ([Source Code](https://github.com/cdevroe/unmark)) `MIT` `PHP`
...
Some [Groupware](#groupware) solutions also feature calendar/address book editing and synchronization.
  ...
  * [Baïkal](http://sabre.io/baikal/) - Lightweight CalDAV+CardDAV server. ([Source Code](https://github.com/fruux/Baikal)) `GPLv3` `PHP`
  * [CalendarServer](https://trac.calendarserver.org/) - A standards-compliant server implementing the CalDAV and CardDAV protocols. `Apache` `Python`
  * [calypso](https://keithp.com/calypso/) - A python-based CalDAV/CardDAV server. ([Source Code](https://keithp.com/cgi-bin/gitweb.cgi?p=calypso.git;a=tree)) `GPLv3` `Python`
  * [DAViCal](https://www.davical.org/) - A server for calendar sharing (CalDAV). ([Source Code](https://about.gitlab.com/davical-project/davical)) `MIT` `PHP`
...
### Custom
  ...
  * [Jitsi Meet](https://jitsi.org/jitsi-meet/) - Jitsi Meet is an OpenSource (MIT) WebRTC Javascript application that uses Jitsi Videobridge to provide high quality, scalable video conferences. ([Source Code](https://github.com/jitsi/jitsi-meet)) `MIT` `Javascript`
  * [Jitsi Video Bridge](https://jitsi.org/jitsi-videobridge/) - WebRTC compatible Selective Forwarding Unit (SFU) that allows for multiuser video communication. ([Source Code](https://github.com/jitsi/jitsi-videobridge)) `Apache` `Java`
  ...
  * [Live Helper Chat](https://livehelperchat.com/) - Live Support chat for your website. ([Source Code](https://github.com/LiveHelperChat/livehelperchat)) `Apache` `PHP`
  * [Mattermost](https://www.mattermost.org/) - Open-source, on-prem Slack-alternative. It can be integrated with [Gitlab](https://about.gitlab.com/). ([Source Code](https://github.com/mattermost/platform)) `AGPLv3/Apache` `Go`
  ...
  * [Niltalk](https://niltalk.com/) - A simple, private, persistence-free web based multi-room chat server + client. ([Source Code](https://github.com/knadh/niltalk)) `AGPLv3` `Go`
  ...
  * [RetroShare](http://retroshare.sourceforge.net) - Secured and decentralized communication system. Offers decentralized chat, forums, messaging, file transfer. ([Source Code](https://github.com/RetroShare/RetroShare)) `GPLv2` `С++`
  ...
  * [Spectrum 2](http://spectrum.im/) - Spectrum 2 is an open source instant messaging transport.  It allows users to chat together even when they are using different IM networks. ([Source Code](https://github.com/SpectrumIM/spectrum2)) `GPLv3` `C++`
  ...
  * [Synapse](http://matrix.org/docs/projects/server/synapse.html) - A server for [Matrix](https://matrix.org/), an open standard for decentralized persistent communication. ([Source Code](https://github.com/matrix-org/synapse)) `Apache` `Python`
    ...
    * [RIOT](https://about.riot.im) - A glossy Matrix web client with an emphasis on performance and usability. ([Source Code](https://github.com/vector-im/riot-web)) `Apache` `Javascript`
...
_simple deployment of a mail server, e.g. for inexperienced or impatient admins._
  ...
  * [Citadel](http://www.citadel.orgdoku.php) - Feature packed, easy, versatile, and powerful mail server, thanks to exclusive "rooms" based architecture. ([Source Code](http://code.citadel.org/?p=citadel.git;a=summary)) `GPLv3` `C`
  ...
  * [iRedMail](http://www.iredmail.org/) - Full-featured mail server solution based on Postfix and Dovecot. ([Source Code](https://bitbucket.org/zhb/iredmail/commits/all)) `GPLv3` `Shell`
  * [Mailcow](https://mailcow.email/) - Mail server suite based on Dovecot, Postfix and other open source software, that provides a modern Web UI for administration. ([Source Code](https://github.com/mailcow/mailcow)) `GPLv2` `PHP`
  ...
  * [Modoboa](https://modoboa.org/en/) - Modoboa is a mail hosting and management platform including a modern and simplified Web User Interface. ([Source Code](https://github.com/modoboa/modoboa)) `MIT` `Python`
...
* [Exim](https://www.exim.org/) - Message transfer agent (MTA) developed at the University of Cambridge. ([Source Code](https://git.exim.org/exim.git)) `GPLv3` `C`
...
* [Sendmail](https://www.sendmail.com/sm/open_source/) - Message transfer agent (MTA). `SENDMAIL` `C`
* [Slimta](http://slimta.org/en/latest/) - Mail Transfer Library built on Python. ([Source Code](https://github.com/slimta/python-slimta)) `MIT` `Python`

#### Mail Delivery Agents

_MDAs - IMAP/POP3 software_

* [Cyrus IMAP/POP3](https://www.cyrusimap.org/) - Intended to be run on sealed servers, where normal users are not permitted to log in. ([Source Code](https://github.com/cyrusimap/cyrus-imapd )) `BSD` `C`
* [Dovecot](https://www.dovecot.org/) - IMAP and POP3 server written primarily with security in mind. ([Source Code](https://github.com/dovecot/core)) `MIT/LGPLv2` `C`
...
_Mailing lists servers and mass mailing software - one message to many recipients._
  ...
  * [Mailtrain](https://mailtrain.org/) - self hosted newsletter application built on Node.js (v5+) and MySQL (v5.5+ or MariaDB). ([Source Code](https://github.com/Mailtrain-org/mailtrain)) `GPLv3` `Nodejs`
  ...
  * [phpList](https://www.phplist.org/) - Newsletter and email marketing with advanced management of subscribers, bounces, and plugins. ([Source Code](https://github.com/phpList/)) `AGPLv3` `PHP`
...
#### Webmail clients
  ...
  * [Cypht](https://cypht.org/index.html) - A feed reader for your email accounts. ([Source Code](https://github.com/jasonmunro/cypht)) `GPLv2` `PHP`
  ...
  * [RainLoop](http://www.rainloop.net/) - Simple, modern & fast webmail with IMAP/SMTP Support and multi accounting. ([Demo](https://mail.rainloop.net/), [Source Code](https://github.com/RainLoop/rainloop-webmail)). `AGPLv3` `PHP`
  ...
  * [WebMail Lite](https://www.afterlogic.org/webmail-lite) - Web-based IMAP Mail client. ([Source Code](https://github.com/afterlogic/webmail-lite)) `GPLv3` `PHP`
...
_[SIP](https://en.wikipedia.org/wiki/Session_Initiation_Protocol) telephony software_
  ...
  * [Kamailio](https://www.kamailio.org/w/) - Modular SIP server (registrar/proxy/router/etc). ([Source Code](https://github.com/kamailio/kamailio)) `GPLv2` `C`
...
_[IPBX](https://en.wikipedia.org/wiki/IP_PBX) telephony software_
  ...
  * [Freepbx](https://www.freepbx.org/) - Web-based open source GUI that controls and manages Asterisk. ([Source Code](https://git.freepbx.org/projects/FREEPBX)) `GPLv2` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [diaspora*](https://diasporafoundation.org/) - Distributed social networking server. ([Demo](https://loma.ml), [Source Code](https://github.com/diaspora/diaspora)) `AGPLv3` `Ruby`
  ...
  * [FluxBB](https://fluxbb.org/) - Fast, light, user-friendly forum software for your website. ([Source Code](https://github.com/fluxbb/fluxbb)) `GPLv2` `PHP`
  * [Friendica](http://www.friendica.com/) - Social Communication Server. ([Source Code](https://github.com/friendica/friendica)) `AGPLv3` `PHP`
  ...
  * [Hubzilla](https://project.hubzilla.org/) - Decentralized identity, privacy, publishing, sharing, cloud storage, and communications/social platform. ([Source Code](https://github.com/redmatrix/hubzilla)) `MIT` `PHP`
  * [HumHub](https://www.humhub.org/en) - A flexible kit for private social networks. ([Source Code](https://github.com/humhub/humhub)) `AGPLv3` `PHP`
  * [Isso](https://posativ.org/isso/) - A lightweight commenting server written in Python and Javascript. It aims to be a drop-in replacement for Disqus. ([Source Code](https://github.com/posativ/isso)) `MIT` `Python`
  ...
  * [Mastodon](https://mastodon.social/about) - Federated microblogging server, an alternative to GNU social. ([Source Code](https://github.com/tootsuite/mastodon)) `AGPLv3` `Ruby`
  ...
  * [MyBB](https://www.mybb.com/) - Free, extensible forum software package. ([Source Code](https://github.com/mybb/mybb)) `LGPLv3` `PHP`
  ...
  * [Oxwall](https://www.oxwall.com) - Oxwall is used for a wide range of projects starting from family sites and custom social networks to collaboration tools and enterprise community solutions. ([Source Code](https://bitbucket.org/oxwall/public)) `CPALv1` `PHP`
  ...
  * [Pump.io](http://pump.io/) - Stream server that does most of what people really want from a social network. ([Source Code](https://github.com/pump-io/pump.io)) `Apache` `Nodejs`
  ...
  * [Telescope](http://www.telescopeapp.org/) - An open-source social news app built with Meteor. ([Demo](http://demo.telescopeapp.org/), [Source Code](https://github.com/VulcanJS/Vulcan)) `MIT` `Nodejs`
  ...
  * [Vanilla Forums](https://vanillaforums.com/en/software) - Simple and flexible forum software. ([Source Code](https://github.com/vanilla/vanilla)) `GPLv2` `PHP`
...
#### XMPP Web Clients
  ...
  * [JSXC](https://www.jsxc.org/) - A Real-time XMPP web chat application with video calls, file transfer and encrypted communication. There are also versions for Nextcloud/Owncloud and SOGo. ([Source Code](https://github.com/jsxc/jsxc)) `MIT` `Javascript`
  ...
  * [Salut à Toi](https://salut-a-toi.org/) - Multipurpose, multi frontend, libre and decentralised communication tool. ([Source Code](https://repos.goffi.org/sat)) `AGPLv3` `Python`
    * [Libervia](https://wiki.goffi.org/wiki/Libervia/en) - Web frontend from Salut à Toi. ([Source Code](https://repos.goffi.org/libervia)) `AGPLv3` `Python`
...
CMS are a practical way to setup a website with many features. CMS often come with third party plugins, themes and functionality that is easy to add and customize to your needs. See also [Blogging Platforms](#blogging-platforms) and [Static Site Generators](#static-site-generators)
  ...
  * [Apostrophe 2](http://apostrophecms.org/) - A node.js CMS with a focus on extensible in-context editing tools. ([Demo](http://demo.apostrophenow.com/spinup), [Source Code](https://github.com/punkave/apostrophe)) `MIT` `Nodejs`
  ...
  * [CouchCMS](https://www.couchcms.com/) - Simple Open-Source CMS for designers. ([Source Code](https://github.com/CouchCMS/CouchCMS)) `CPALv1` `PHP`
  ...
  * [eLabFTW](https://www.elabftw.net/) - An online lab notebook for research labs. Store experiments, use a database to find reagents or protocols, use trusted timestamping to legally timestamp an experiment, export as pdf or zip archive, share with collaborators…. ([Demo](https://demo.elabftw.netexperiments.php), [Source Code](https://github.com/elabftw/elabftw)) `AGPLv3` `PHP`
  ...
  * [ImpressPages CMS](https://www.impresspages.org/) - Easy code meets easy admin. ([Demo](http://69042.cloud.impresspages.org?pa=CloudService.autologin&key=hLlqljhAqxuEibLuKlmZq2qrrtXetteC6pSiz1IQn3kw4XQF84toXLHe5tjp), [Source Code](https://github.com/impresspages/ImpressPages)) `GPLv3/MIT` `PHP`
  ...
  * [MODX](https://modx.com/) - MODX is an advanced content management and publishing platform. The current version is called 'Revolution'. ([Source Code](https://github.com/modxcms/revolution)) `GPLv2` `PHP`
  ...
  * [Pimcore](https://www.pimcore.org/en) - Multi-Channel Experience and Engagement Management Platform. ([Source Code](https://github.com/pimcore/pimcore)) `BSD` `PHP`
  ...
  * [Publify](https://github.com/publify/publify) - A simple but full featured web publishing software. ([Demo](https://demo.publify.co/), [Source Code](https://github.com/publify/publify)) `MIT` `Ruby`
  * [REDAXO](https://redaxo.org/) - A simple, flexible and useful content management system (documentation only available in German). ([Source Code](https://github.com/redaxo/redaxo)) `MIT` `PHP`
  ...
  * [Sphido](https://www.sphido.org/) - A fast, lightweight, flat file CMS for PHP. ([Source Code](https://github.com/sphido/cms)) `MIT` `PHP`
  * [SPIP](https://www.spip.net/fr) - Publication system for the Internet aimed at collaborative work, multilingual environments, and simplicity of use for web authors. ([Source Code](https://core.spip.net/projects/spip/repository)) `GPLv2` `PHP`
  * [Subrion](https://subrion.org/) - Subrion is a free open source content management system that allows you to build websites for any purpose. Yes, from blog to corporate mega portal. ([Demo](http://demos.subrion.org/), [Source Code](https://github.com/intelliants/subrion)) `GPLv3` `PHP`
  * [Textpattern](http://textpattern.com/) - A flexible, elegant and easy-to-use CMS. ([Demo](https://textpattern.co/demo), [Source Code](https://github.com/textpattern/textpattern)) `GPLv2` `PHP`
...
### E-commerce
  ...
  * [Microweber](https://microweber.com/) - Drag and Drop CMS and online shop. ([Demo](http://demo2.microweber.com/api/user_login?username=demomic6&password=7Mp1Ve32vk&redirect=http://demo2.microweber.com/versace?editmode=y), [Source Code](https://github.com/microweber/microweber)) `Apache` `PHP`
  ...
  * [Open Classifieds](http://open-classifieds.com/) - Free open-source, self-hosted CMS for classifieds sites. ([Source Code](https://github.com/yclas/yclas)) `GPL` `PHP`
  * [Open eShop](https://open-eshop.com/) - Sell your digital goods with licenses and provide support. ([Source Code](https://github.com/belherdigital/open-eshop)) `GPL` `PHP`
  ...
  * [OXID eShop](https://oxidforge.org/) - OXID eShop is a flexible open source e-commerce software with a wide range of functionalities. ([Demo](http://demoshop.oxid-esales.com/community-edition/), [Source Code](https://github.com/OXID-eSales/oxideshop_ce)) `GPLv3` `PHP`
  ...
  * [PrestaShop](https://www.prestashop.com/en) - PrestaShop offers a free, open-source and fully scalable e-commerce solution. ([Demo](http://demo.prestashop.com/en/), [Source Code](https://github.com/PrestaShop/PrestaShop)) `OSLv3` `PHP`
  * [Pretix](https://pretix.eu/about/en/) - Django based ticket sales platform for events. ([Source Code](https://github.com/pretix)) `Apache` `Python`
  * [Shuup](https://www.shuup.com/en/) - Django powered fully customizable open source e-commerce framework for small and large sites. ([Demo](https://www.shuup.com/en/demo/), [Source Code](https://github.com/shuup/shuup)) `AGPLv3` `Python`
  ...
  * [Thelia](https://thelia.net/) - Thelia is an open source and flexible e-commerce solution. ([Demo](http://demo.thelia.net/), [Source Code](https://github.com/thelia/thelia)) `LGPL` `PHP`
  * [WooCommerce](https://woocommerce.com/woocommerce/) - WordPress based e-commerce solution. ([Source Code](https://github.com/woocommerce/woocommerce)) `GPL` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [CUPS](https://www.cups.org/) - The Common Unix Print System uses Internet Printing Protocol (IPP) to support printing to local and network printers. ([Source Code](https://www.cups.org/software.html)) `GPLv2` `C`
...
* [Odoo](https://www.odoo.com/) - Free open source ERP system. ([Demo](https://master.odoo.com/saas_master/demo/), [Source Code](https://github.com/odoo/odoo)) `LGPLv3` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [FreshRSS](https://freshrss.org/) - A self-hostable RSS feed aggregator. ([Demo](http://demo.freshrss.org/i/), [Source Code](https://github.com/FreshRSS/FreshRSS), [Mobile app](https://github.com/Alkarex/EasyRSS)) `AGPLv3` `PHP`
  * [JARR](https://1pxsolidblack.pl/jarr-en.html) - JARR (Just Another RSS Reader) is a web-based news aggregator and reader. ([Demo](https://jarr.info/login?next=%2F), [Source Code](https://github.com/jaesivsm/JARR)) `AGPLv3` `Python`
  ...
  * [Leed](http://lightspeed1.nsnet.net/access/web?id=fd3bff7d-6bd8-11e7-8b13-00e0ed148814) - Leed (for Light Feed) is a Free and minimalist RSS aggregator. ([Source Code](https://github.com/LeedRSS/Leed)) `AGPLv3` `PHP`
  * [Leselys](https://github.com/toxinu/leselys) - Your very elegant RSS reader. `AGPLv3` `Python`
  ...
  * [Moonmoon](http://moonmoon.org/) - simple feed agregator (planet like): it only aggregates feeds and spits them out in one single page. ([Source Code](https://github.com/moonmoon/moonmoon)) `BSD` `PHP`
  ...
  * [Nunux Reader](https://reader.nunux.org/) - A simple, fast and reactive RSS reader. ([Source Code](https://github.com/ncarlier/nunux-reader)) `GPLv3` `Nodejs`
  * [Reader-Self](https://readerself.com/) - Self-hosted rss reader (php / mysql or sqlite) - Google Reader alternative. ([Source Code](https://github.com/readerself/readerself)) `GPLv3` `PHP`
  ...
  * [Selfoss](https://selfoss.aditu.de/) - The new multipurpose rss reader, live stream, mashup, aggregation web application. ([Source Code](https://github.com/SSilence/selfoss)) `AGPLv3` `PHP`
  ...
  * [Tiny Tiny RSS](https://tt-rss.org/gitlab/fox/tt-rss) - Open source web-based news feed (RSS/Atom) reader and aggregator. ([Demo](https://framanews.org/)) `GPLv3` `PHP`
...
#### File transfer/synchronization
  ...
  * [Z-Push](http://z-push.org/) - An implementation of Microsoft’s [ActiveSync](https://en.wikipedia.org/wiki/ActiveSync) protocol. ([Source Code](https://stash.z-hub.io/projects/ZP/repos/z-push/browse)) `AGPLv3` `PHP`

#### Peer-to-peer filesharing

  * [bittorrent-tracker](https://webtorrent.io/) - Simple, robust, BitTorrent tracker (client & server) implementation. ([Source Code](https://github.com/webtorrent/bittorrent-tracker)) `MIT` `Nodejs`
  * [FilePizza](https://file.pizza/) - Peer-to-peer file transfers in your browser. ([Source Code](https://github.com/kern/filepizza)) `BSD` `Nodejs`
...
#### Single-click/drag-n-drop upload
  ...
  * [droppy](https://github.com/silverwind/droppy) - droppy is a self-hosted cloud server with an interface similar to desktop file managers and has capabilites to edit files on-the-fly as well as view and playback media directly in the browser. ([Demo](https://droppy.silverwind.io/)) `BSD` `Nodejs`
  * [FileShelter](https://github.com/epoupon/fileshelter) - FileShelter is a self-hosted software that allows you to easily share files over the Internet. ([Demo](http://lightspeed1.nsnet.net/access/web?id=0022e77e-6bd9-11e7-8b13-00e0ed148814)) `GPLv3` `C++`
  ...
  * [ipfs.pics](https://ipfs.pics/) - ipfs.pics is a o distributed image hosting website. ([Source Code](https://github.com/ipfspics/ipfspics-server)) `AGPLv3` `PHP`
  ...
  * [uPste](https://pste.pw/) - A private file hosting application with an emphasis on serving technology communities. ([Source Code](https://github.com/TheReverend403/uPste)) `AGPLv3` `PHP`
  * [YouTransfer](http://www.youtransfer.io) - YouTransfer is a simple but elegant self-hosted file transfer & sharing solution. ([Demo](http://demo.youtransfer.io/), [Source Code](https://github.com/YouTransfer/YouTransfer)) `Apache` `Nodejs`
...
#### Web based file managers
  ...
  * [Monsta FTP](https://www.monstaftp.com/) - Open source PHP/Ajax cloudware that puts FTP file management right in your browser, anywhere, any time. ([Demo](https://mftp.live/), [Source Code](https://github.com/MonstaApps/Monsta-FTP)) `GPLv3` `PHP`
  * [ResourceSpace](http://www.resourcespace.com/) - ResourceSpace open source digital asset management software is the simple, fast, & free way to organise your digital assets. ([Demo](http://www.resourcespace.com/trial), [Source Code](http://www.resourcespace.com/svn)) `BSD/Other` `PHP`
  * [Sprut.io](https://sprut.io/en) - 2 panel file manager with drag and drop features, code editor, text search, hotkeys. ([Demo](https://demo.sprut.io:9443), [Source Code](https://github.com/LTD-Beget/sprutio)) `GPLv3` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [Guacamole](http://guacamole.incubator.apache.org/) - Guacamole is a clientless remote desktop gateway. It supports standard protocols like VNC and RDP. ([Source Code](https://github.com/glyptodon/)) `Apache` `Java/C`
  ...
  * [OS.js](https://www.os-js.org/) - A desktop implementation for your browser with a fully-fledged window manager, Application APIs, GUI toolkits and filesystem abstraction. ([Demo](https://osjsv2.0o.no/), [Source Code](https://github.com/os-js/OS.js)) `BSD` `Nodejs`
...
**[`^        back to top        ^`](#)**
  ...
  * [Cozy Cloud](https://cozy.io/en/) - A personal cloud where you can read your emails or manage and sync your contact, files or calendars, with an app store full of community contributions. ([Source Code](https://github.com/cozy)) `GPLv3` `Nodejs`
  * [egroupware](http://www.egroupware.org/en/) - Software suite including calendars, address books, notepad, project management tools, client relationship management tools (CRM), knowledge management tools, a wiki and a CMS. ([Source Code](https://github.com/EGroupware/egroupware)) `GPLv2` `PHP`
  * [Horde](https://www.horde.org/) - The Horde Project is about creating high quality Open Source applications and libraries, based on PHP and the Horde Framework. ([Demo](http://demo.horde.org/login.php), [Source Code](https://github.com/horde/horde)) `GPLv2` `PHP`
  ...
  * [Kopano](https://kopano.com/) - Groupware suite including e-mail, calendars, tasks, todos and notes. Featuring a modern WebApp, DeskApp and mobile access over Z-Push/ActiveSync. ([Demo](https://demo.kopano.com/), [Source Code](https://stash.kopano.io/dashboard)) `AGPLv3` `C/Python/PHP`
  * [Mayan EDMS](http://www.mayan-edms.com) - Free Open Source Electronic Document Management System. An electronic vault for your documents with preview generation, OCR, and automatic categorization among other features. ([Demo](http://demo.mayan-edms.com/authentication/login/?next=/), [Source Code](https://gitlab.com/mayan-edms/mayan-edms)) `Apache` `Python`
  ...
  * [Sogo](https://sogo.nu/) - SOGo offers multiple ways to access the calendaring and messaging data. CalDAV, CardDAV, GroupDAV, as well as ActiveSync, including native Outlook compatibility and web interface. ([Demo](http://demo.sogo.nu/SOGo/index), [Source Code](https://github.com/inverse-inc/sogo)) `GPLv1/LGPLv2` `Objective-C`
  * [Tine 2.0](http://www.tine20.com/willkommen-community/) - Contacts, Calendar, Tasks, WebDAV, ActiveSync, VOIP, Mail-Client, CRM, Sales, Projects, Timetracker. ([Demo](https://demo.tine20.net), [Source Code](https://packages.tine20.com/maintenance/source/)) `AGPLv3/Other` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [admidio](https://www.admidio.org/) - Admidio is a free open source user management system for websites of organizations and groups. The system has a flexible role model so that it’s possible to reflect the structure and permissions of your organization. ([Demo](https://www.admidio.org/demo/adm_program/modules/announcements/announcements.php), [Source Code](https://github.com/Admidio/admidio)) `GPLv2` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [ILIAS](https://www.ilias.de/) - ILIAS is the Learning Management System that can cope with anything you throw at it. ([Demo](https://demo.ilias.de/), [Source Code](https://github.com/ILIAS-eLearning/ILIAS)) `GPLv3` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Graphhopper](https://www.graphhopper.com/) - Fast routing library and server using OpenStreetMap. ([Source Code](https://github.com/graphhopper/graphhopper)) `Apache` `Java`
...
### Audio Streaming
  ...
  * [cloudtunes](https://github.com/jakubroztocil/cloudtunes) `⚠` - Web-based music player for the cloud. `MIT` `Python`
  ...
  * [Groove Basin](http://lightspeed1.nsnet.net/access/web?id=086c2c24-6bd9-11e7-8b13-00e0ed148814) - A music player server with a web-based user interface inspired by Amarok 1.4. ([Source Code](https://github.com/andrewrk/groovebasin)) `MIT` `Nodejs`
  ...
  * [koel](https://koel.phanan.net/) - A personal music streaming server that works. ([Source Code](https://github.com/phanan/koel)) `MIT` `PHP`
  * [Libresonic](https://libresonic.org/) - Open-source web-based media streamer and jukebox. A fork of Subsonic's last open-source release, before it switched licenses. `GPLv3` `Java`
  ...
  * [mpd](https://www.musicpd.org/) - Daemon to remotely play music, stream music, handle and organize playlists. Many clients available. `GPLv2` `C++`
  * [mStream](http://mstream.io/) - Music streaming server with GUI management tools. Runs on Mac, Windows, and Linux. ([Demo](https://darncoyotes.mstream.io/), [Source Code](https://github.com/IrosTheBeggar/mStream)) `GPLv2` `Nodejs`
   * [ympd](https://www.ympd.org/) - Standalone MPD Web GUI written in C, utilizing Websockets and Bootstrap/JS. ([Source Code](https://github.com/notandy/ympd)) `GPLv2` `C`
  * [Sonerezh](https://www.sonerezh.bzh/) - A self-hosted, web-based application for stream your music, everywhere. ([Demo](https://www.sonerezh.bzh/demo/login), [Source Code](https://github.com/sonerezh/sonerezh)) `GPLv3` `PHP`

### Video Streaming

  * [CyTube](https://github.com/calzoneman/sync) - CyTube is a web application providing media synchronization, chat, and more for an arbitrary number of channels. ([Demo](http://lightspeed1.nsnet.net/access/web?id=09479e9c-6bd9-11e7-8b13-00e0ed148814)) `MIT` `Nodejs`
  * [Emby](https://emby.media/) - A home media server built using other popular open source technologies. ([Source Code](https://github.com/MediaBrowser/Emby)) `GPLv2` `C#`
  ...
  * [Icecast 2](http://www.icecast.org/) - streaming audio/video server which can be used to create an Internet radio station or a privately running jukebox and many things in between. ([Source Code](https://git.xiph.org/?p=icecast-server.git;a=summary)) `GPLv2` `C`
  * [MistServer](https://mistserver.org/) - A streaming media server that works well in any streaming environment. ([Source Code](https://github.com/DDVTECH/mistserver)) `AGPLv3` `C++`
  * [Odd Networks](https://oddnetworks.com/) - Open source video management system (VMS) and API for collections and videos with supporting SDKs for Roku, Apple iOS/tvOS, Google Android, and Amazon FireTV. ([Source Code](https://github.com/oddnetworks/oddworks)) `MIT` `Nodejs`
  * [ReadyMedia](https://sourceforge.net/projects/minidlna/) - A simple media server software, with the aim of being fully compliant with DLNA/UPnP-AV clients. `GPLv2` `C`
...
**[`^        back to top        ^`](#)**
  ...
  * [EasyBook Project](http://lightspeed1.nsnet.net/access/web?id=0a579b30-6bd9-11e7-8b13-00e0ed148814) - Book publishing as easy as it should be. ([Source Code](https://github.com/javiereguiluz/easybook)) `MIT` `PHP`
  ...
  * [ViMbAdmin](https://www.vimbadmin.net/) - Provides a web based virtual mailbox administration system to allow mail administrators to easily manage domains, mailboxes and aliases. ([Demo](https://www.vimbadmin.net/demo/auth/login), [Source Code](https://github.com/opensolutions/ViMbAdmin)) `GPLv3` `PHP`
  * [visualCaptcha](https://visualcaptcha.net/) - A configurable captcha solution, focusing on accessibility & simplicity whilst maintaining security. ([Demo](https://demo.visualcaptcha.net/), [Source Code](https://github.com/emotionLoop/visualCaptcha)) `MIT` `PHP/Nodejs/Ruby/Python`
  * [webtrees](https://www.webtrees.net/index.php/en/) - webtrees is the web's leading on-line collaborative genealogy application. ([Demo](https://dev.webtrees.net/demo-stable/index.php?ctype=gedcom&ged=demo), [Source Code](https://github.com/fisharebest/webtrees)) `GPLv3` `PHP`
...
See also https://github.com/n1trux/awesome-sysadmin#it-asset-management
  ...
  * [Firefly III](https://firefly-iii.github.io/) - Firefly III is a modern financial manager. It helps you to keep track of your money and make budget forecasts. It supports credit cards, shared household accounts, and savings accounts. It's powered by Laravel and requires PHP7. ([Demo](https://firefly-iii.nder.be/login), [Source Code](https://github.com/firefly-iii/firefly-iii)) `CCBYSAv4` `PHP`
  * [Galette](http://galette.eu/dc/) - Galette is a membership management web application towards non profit organizations. ([Source Code](https://git.tuxfamily.org/galette/galette.git/)) `GPLv3` `PHP`
  ...
  * [Invoice Ninja](https://www.invoiceninja.org/) - A powerful tool to invoice clients online. ([Demo](https://app.invoiceninja.com/login), [Source Code](https://github.com/invoiceninja/invoiceninja)) `AAL` `PHP`
  * [InvoicePlane](https://invoiceplane.com/) - Manage quotes, invoices, payments and customers for your small business. ([Demo](https://demo.invoiceplane.com/index.php/sessions/login), [Source Code](https://github.com/InvoicePlane/InvoicePlane)) `MIT` `PHP`
  * [IHateMoney](https://ihatemoney.org/) - Manage your shared expenses, easily. ([Source Code](https://github.com/spiral-project/ihatemoney)) `BSD` `Python`
...
*See also [Wikis](#wikis)*
  ...
  * [Leanote](http://leanote.org/) - Leanote, Not Just A Notepad! Open source cloud notepad. ([Demo](https://leanote.com/login), [Source Code](https://github.com/leanote/leanote)) `GPLv2` `Go`
  * [Markdown Edit](http://georgeosddev.github.io/markdown-edit/) - Online markdown editor/viewer. ([Source Code](https://github.com/georgeOsdDev/markdown-edit)) `MIT` `HTML5`
  ...
  * [savepad](https://github.com/fendatr/textpad) - A minimalist notepad based on notepad.cc. `MIT` `PHP`
  ...
  * [Turtl](https://turtlapp.com/) - A totally private personal database and note taking app. ([Source Code](https://github.com/turtl)) `GPLv3` `CommonLisp`
...
**[`^        back to top        ^`](#)**
  ...
  * [Etherpad](http://etherpad.org/) - Etherpad is a highly customizable Open Source online editor providing collaborative editing in really real-time. ([Demo](https://oasis.sandstorm.io/appdemo/h37dm17aa89yrd8zuqpdn36p6zntumtv08fjpu8a8zrte7q1cn60), [Source Code](https://github.com/ether/etherpad-lite)) `Apache` `Nodejs`
...
**[`^        back to top        ^`](#)**
  ...
  * [hastebin](https://hastebin.com/about.md) - Open source pastebin written in node.js. ([Demo](http://hastebin.com/), [Source Code](https://github.com/seejohnrun/haste-server)) `MIT` `Nodejs`
  ...
  * [Modern Paste](http://modernpaste.com/) - Modern pastebin with a contemporary, minimalistic user interface backed by a robust feature set. ([Demo](https://demo.modernpaste.com/), [Source Code](https://github.com/LINKIWI/modern-paste)) `MIT` `Python`
  * [mojopaste](http://search.cpan.org/dist/App-mojopaste/) - Perl based pastebin. ([Demo](https://ssl.thorsen.pm/paste/), [Source Code](https://github.com/jhthorsen/app-mojopaste)) `ARTv2` `Perl`
  ...
  * [Paste](https://phpaste.sourceforge.io/) - Paste is forked from the original source pastebin.com used before it was bought. ([Demo](https://phpaste.sourceforge.io/demo), [Source Code](https://github.com/jordansamuel/PASTE)) `GPLv3` `PHP`
  ...
  * [snipt](https://github.com/nicksergeant/snipt) - Long-term memory for coders. Share and store code snippets. ([Source Code](https://github.com/nicksergeant/snipt/)) `BSD` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [Habitica](https://habitica.com/) - A habit tracker app which treats your goals like a Role Playing Game. Previously called HabitRPG. ([Source Code](https://github.com/HabitRPG/habitica)) `GPLv3/Other` `Nodejs`
  ...
  * [Tipboard](http://lightspeed1.nsnet.net/access/web?id=13127b03-6bd9-11e7-8b13-00e0ed148814) - In-house, tasty, local dashboarding system. ([Source Code](https://github.com/allegro/tipboard)) `Apache` `Python`
  * [wger](https://wger.de/en/en//) - A web-based personal workout, fitness and weight logger/tracker. It can also be used as a simple gym management utility and offers a full REST API as well. ([Demo](https://wger.de), [Source Code](https://github.com/wger-project/wger)) `AGPLv3` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [Lychee](https://lychee.electerious.com/) - An open source grid and album based photo-management-system. ([Source Code](https://github.com/electerious/Lychee)) `MIT` `PHP`
  * [MediaDrop](https://mediadrop.video/) - A video, audio and podcast publication platform. ([Source Code](https://github.com/mediadrop/mediadrop)) `GPLv3` `Python`
  * [Mediagoblin](https://mediagoblin.org/) - A Free software media publishing platform that anyone can run. You can think of it as a decentralized alternative to Flickr, YouTube, SoundCloud, etc. `AGPLv3` `Python`
  ...
  * [Photofloat](https://blog.zx2c4.com/567) - A Web 2.0 Photo Gallery Done Right via Static JSON & Dynamic Javascript. ([Demo](https://photos.jasondonenfeld.com/)) `GPLv2` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [MaterialPoll](https://github.com/nearbycoder/materialpoll) - An opensource strawpoll.me clone for creating random polls. ([Demo](http://lightspeed1.nsnet.net/access/web?id=153ed33d-6bd9-11e7-8b13-00e0ed148814), [Source Code](https://github.com/nearbycoder/materialpoll)) `MIT` `Nodejs`
  ...
  * [TellForm](https://tellform.com) - A beautiful online form and survey creator. ([Demo](https://tellform.com/examples), [Source Code](https://github.com/tellform/tellform)) `MIT` `Nodejs`
...
**[`^        back to top        ^`](#)**
  ...
  * [Oranjeproxy](https://lehollandaisvolant.net/tout/oranjeproxy/) - Anonymizing web proxy. ([Source Code](https://github.com/AmauryCarrade/OranjeProxy)) `GPLv2` `PHP`
  ...
  * [Privoxy](http://lightspeed1.nsnet.net/access/web?id=16016799-6bd9-11e7-8b13-00e0ed148814) - A non-caching web proxy with advanced filtering capabilities for enhancing privacy, modifying web page data and HTTP headers, controlling access, and removing ads and other obnoxious Internet junk. `GPLv2` `C`
  * [Squid](http://lightspeed1.nsnet.net/access/web?id=16083545-6bd9-11e7-8b13-00e0ed148814) - Caching proxy for the Web supporting HTTP, HTTPS, FTP, and more. It reduces bandwidth and improves response times by caching and reusing frequently-requested web pages. ([Source Code](https://code.launchpad.net/squid)) `GPLv2` `C`
  ...
  * [Tinyproxy](https://tinyproxy.github.io/) - Light-weight HTTP/HTTPS proxy daemon. ([Source Code](https://github.com/tinyproxy/tinyproxy)) `GPLv2` `C`
...
**[`^        back to top        ^`](#)**
  ...
  * [Nunux Keeper](https://keeper.nunux.org/) - Your personal content curation service. ([Source Code](https://github.com/ncarlier/nunux-keeper)) `GPLv3` `Nodejs`
  * [Wallabag](https://www.wallabag.org/en) - Wallabag, formerly Poche, is a web application allowing you to save articles to read them later with improved readability. ([Demo](http://demo.wallabag.org/), [Source Code](https://github.com/wallabag/wallabag)) `MIT` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Yacy](http://lightspeed1.nsnet.net/access/web?id=168af364-6bd9-11e7-8b13-00e0ed148814) - Peer based, decentralized search engine server. `GPL2` `Java`
...
_See also [Ticketing](#ticketing), [Task management/To-do lists](#task-managementto-do-lists)_
  ...
  * [Gitea](https://gitea.io/en-US/) - A community managed fork of Gogs, lightweight code hosting solution. ([Demo](https://try.gitea.io), [Source Code](https://github.com/go-gitea/gitea)) `MIT` `Go`
  * [GitLab](https://about.gitlab.com/) - Self Hosted Git repository management, code reviews, issue tracking, activity feeds and wikis. ([Demo](https://gitlab.com/), [Source Code](https://gitlab.com/gitlab-org/gitlab-ce)) `MIT` `Ruby`
  ...
  * [Phabricator](https://www.phacility.com/) - Collection of web applications that help build better software. ([Demo](https://secure.phabricator.com/), [Source Code](https://github.com/phacility/phabricator)) `Apache` `PHP`
  ...
  * [RhodeCode](https://rhodecode.com/) - RhodeCode is an open source platform for software development teams. It unifies and simplifies repository management for Git, Subversion, and Mercurial. ([Demo](https://code.rhodecode.com/), [Source Code](https://code.rhodecode.com/)) `AGPLv3` `Python`
  ...
  * [Trac](https://trac.edgewall.org/) - Trac is an enhanced wiki and issue tracking system for software development projects. `BSD` `Python`
  * [Phproject](https://www.phproject.org/) - A high performance full-featured project management system. ([Demo](https://demo.phproject.org/), [Source Code](https://github.com/Alanaktion/phproject)) `GPLv3` `PHP`
...
### IDE/Tools
  ...
  * [Koding](https://www.koding.com/) - The simplest way to manage your entire Dev Infrastructure. ([Source Code](https://github.com/koding/koding)) `Apache` `Nodejs`
  ...
  * [Wide](https://github.com/b3log/wide) - A Web-based IDE for Teams using Go programming language/Golang. ([Demo](https://wide.b3log.org/signup)) `Apache` `Go`
...
### Continuous Integration
  ...
  * [Jenkins](https://jenkins.io/index.html) - Continuous Integration Server. ([Source Code](https://github.com/jenkinsci/jenkins/)) `MIT` `Java`
 ...
 * [Para](http://paraio.org/) - Para is a flexible and modular backend framework/server for object persistence, API development and authentication. ([Source Code](https://github.com/erudika/para)) `Apache` `Java`
...
### Localization
  ...
  * [Weblate](https://weblate.org/en/) - Web-based translation tool with tight version control integration. ([Demo](https://demo.weblate.org), [Source Code](https://github.com/WeblateOrg/weblate)) `GPLv3` `Python`
...
*See also [Project Management](#project-management) and [Ticketing](#ticketing).*
  ...
  * [Kanboard](https://kanboard.net/) - A simple and open source visual task board. ([Source Code](https://github.com/kanboard/kanboard)) `MIT` `PHP`
  * [Wheatbin](http://www.wheatbin.com/) - A project management software that combines Kanban methodology with the Law of the Harvest. ([Source Code](https://github.com/wheatbin/wheatbin)) `MIT` `PHP`
  ...
  * [Restyaboard](http://restya.com/board/) - Open source Trello-like kanban board. ([Demo](http://restya.com/board/demo), [Source Code](https://github.com/RestyaPlatform/board)) `OSLv3` `PHP`
  ...
  * [TaskBoard](https://taskboard.matthewross.me/) - A Kanban-inspired app for keeping track of things that need to get done. ([Source Code](https://github.com/kiswa/TaskBoard)) `MIT` `PHP`
...
*See also [Task management/To-do lists](#task-managementto-do-lists) and [Project Management](#project-management)*
  ...
  * [Bumpy Booby](http://bumpy-booby.derivoile.fr/default/dashboard) - A simple, responsive and highly customizable PHP bug tracking system. ([Source Code](https://github.com/piero-la-lune/Bumpy-Booby)) `MIT` `PHP`
  * [Cerb](http://cerb.ai/) - Group-based e-mail management project. ([Source Code](https://github.com/wgm/cerb)) `DPL` `PHP`
  ...
  * [DiamanteDesk](https://diamantedesk.com/) - DiamanteDesk is FREE Open Source easy-to-use help-desk solution. ([Demo](https://diamantedesk.com/demo/), [Source Code](https://github.com/eltrino/diamantedesk-application)) `OSLv3` `PHP`
  ...
  * [OTRS](https://www.otrs.com/) - Trouble ticket system for assigning tickets to incoming queries and tracking further communications. ([Source Code](https://github.com/OTRS/otrs)) `AGPLv3` `Perl`
  * [Request Tracker](https://bestpractical.com/rt/) -  An enterprise-grade issue tracking system. ([Source Code](https://github.com/bestpractical/rt)) `GPLv2` `Perl`
...
**[`^        back to top        ^`](#)**
  ...
  * [YOURLS](http://lightspeed1.nsnet.net/access/web?id=1e8fc9de-6bd9-11e7-8b13-00e0ed148814) - YOURLS is a set of PHP scripts that will allow you to run Your Own URL Shortener. Features include password protection, URL customization, bookmarklets, statistics, API, plugins, jsonp. ([Source Code](https://github.com/YOURLS/YOURLS/)) `MIT` `PHP`
...
See also [Documentation Generators](#documentation-generators), [Wikimatrix](http://www.wikimatrix.org/), [Wiki Engines on WikiIndex](http://wikiindex.org/Category:Wiki_Engine), [List of wiki software on wikipedia](https://en.wikipedia.org/wiki/List_of_wiki_software), [Comparison of wiki software on wikipedia](https://en.wikipedia.org/wiki/Comparison_of_wiki_software).
  ...
  * [Blazekiss](http://lightspeed1.nsnet.net/access/web?id=1ed0d3a4-6bd9-11e7-8b13-00e0ed148814) - BlazeKiss is a KISS-based wiki (Keep It Simple, Stupid) - simplicity and functionality comes before all. ([Source Code](https://github.com/ldleman/blazekiss)) `GPLv3` `PHP`
  ...
  * [Mediawiki](https://www.mediawiki.org/wiki/MediaWiki) - MediaWiki is a free and open-source wiki software package written in PHP. It serves as the platform for Wikipedia and the other Wikimedia projects, used by hundreds of millions of people each month. ([Source Code](https://phabricator.wikimedia.org/source/mediawiki/)) `GPLv2` `PHP`
  ...
  * [Redaxscript](https://redaxscript.com/) - Ultra lightweight website engine. ([Source Code](https://github.com/redaxmedia/redaxscript)) `GPLv3` `PHP`
  ...
  * [Tiki](http://tiki.org/tiki-index.php) - Wiki CMS Groupware with the most built-in features. ([Demo](https://tiki.org/Demo), [Source Code](https://sourceforge.net/p/tikiwiki/code/HEAD/tree/)) `LGPLv2` `PHP`
  ...
  * [XWiki](http://www.xwiki.org/xwiki/bin/view/Main/WebHome) - A second generation wiki that allows the user to extend its functionalities with a powerful extension-based architecture. ([Demo](http://playground.xwiki.org/xwiki/bin/view/Main/WebHome), [Source Code](https://github.com/xwiki/xwiki-platform)) `LGPLv2` `Java`
...
**[`^        back to top        ^`](#)**
  ...
  * [DPlatform](https://dfabric.github.io/DPlatform-ShellCore/) - Deploy self-hosted apps easily: simple, bloat-free, independent installation. ([Source Code](https://github.com/DFabric/DPlatform-ShellCore)) `MIT` `Shell`
  ...
  * [Sandstorm](https://sandstorm.io/) - Personal server for running self-hosted apps easily and securely. ([Demo](https://oasis.sandstorm.io/demo), [Source Code](https://github.com/sandstorm-io/sandstorm)) `Apache` `C++/Other`
  ...
  * [WikiSuite](http://WikiSuite.org/Software) - The most comprehensive and integrated Free / Libre / Open Source software suite ever developed. ([Source Code](http://wikisuite.org/Source-Code)) `Multiple` `ClearOS`
 ...
 * `ARTv2` - [Artistic License Version 2.0](https://opensource.org/licenses/Artistic-2.0)
 ...
 * `CC0` - [Public Domain](http://creativecommons.org/share-your-work/public-domain/cc0/)
 ...
 * `CPALv1` - [Common Public Attribution License Version 1.0](https://opensource.org/licenses/CPAL-1.0)
 * `DPL` - [Devblocks Public License 1.0](http://cerb.ai/license)
 * `ECLv2` - [Educational Community License, Version 2.0 ](https://opensource.org/licenses/ECL-2.0)
 ...
 * `LGPLv2` - [Lesser General Public License 2.1](https://opensource.org/licenses/LGPL-2.1)
 * `LGPLv3` - [Lesser General Public License 3.0](https://opensource.org/licenses/LGPL-3.0)
 * `MIT` - [MIT License](https://opensource.org/licenses/MIT)
 * `MPLv1.1` - [Mozilla Public License Version 1.1](https://www.mozilla.org/media/MPL/1.1/index.txt)
 * `MPLv2` - [Mozilla Public License](https://www.mozilla.org/media/MPL/2.0/index.txt)
 ...
 * `WTFPL` - [Do What the Fuck You Want to Public License](http://lightspeed1.nsnet.net/access/web?id=22b1030b-6bd9-11e7-8b13-00e0ed148814)
 * `Zlib` - [Zlib/libpng License](https://opensource.org/licenses/Zlib)
 * `Zope` - [Zope Public License 2.0](https://opensource.org/licenses/ZPL-2.0)
 ...
 * [PRISM Break](https://prism-break.org/en/), [privacytools.io](https://privacytoolsio.github.io/privacytools.io/), [Alternative Internet](https://redecentralize.github.io/alternative-internet/), [Libre Projects](http://libreprojects.net/) - Lists of software aimed at privacy and decentralization (in some form).
