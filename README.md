...
- [NocoDB](https://www.nocodb.com/) - NocoDB is an open source #NoCode platform that turns any database into a smart spreadsheet. It can be consider as a Airtable or Smartsheet alternative. ([Source Code](https://github.com/nocodb/nocodb/stargazers)) `GPL-3.0` `TypeScript/Vue`
