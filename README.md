...
- [selefra.io](https://www.selefra.io/) - n open-source policy-as-code software that provides analytics for multi-cloud and SaaS. ([Source Code](https://github.com/selefra/selefra)) `MPL-2.0` `Go`
