...
- [Navidrome Music Streamer](https://github.com/deluan/navidrome#readme) - 🎧☁️Music Server and Streamer compatible with Subsonic/Airsonic. ([Clients](https://airsonic.github.io/docs/apps/)) `GPL-3.0` `Go/JavaScript`
