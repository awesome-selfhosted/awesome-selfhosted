...
**[`^        back to top        ^`](#)**
  ...
  * [SharpPaste](https://github.com/phonicmouse/SharpPaste) - Cross-platform C# pastebin with client-side encryption that just works. ([Demo](https://sharppaste.nl/)) `MIT` `C#/ASP.NET`
