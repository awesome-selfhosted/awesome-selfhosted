...
- [KodExplorer](https://kodcloud.com/) - A web based file manager and web IDE/browser based code editor. ([Demo](http://demo.kodcloud.com/), [Source Code](https://github.com/kalcaddle/KodExplorer)) `GPL-3.0` `PHP`
