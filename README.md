...
* [LedgerSMB](https://ledgersmb.org/) - The LedgerSMB project brings accounting software integrating invoicing, order processing, quotations and more (ERP) to small and midsize businesses. ([Source Code](https://github.com/ledgersmb/LedgerSMB)) `GPLv2` `Perl`
