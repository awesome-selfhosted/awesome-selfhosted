...
- [LinkWarden](https://github.com/Daniel31x13/link-warden) A self-hosted bookmark + archive manager to store your useful links. ([Demo](linkwarden.netlify.app)) `MIT` `Docker/Nodejs`
