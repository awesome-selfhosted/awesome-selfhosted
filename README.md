...
- [Shopware 5 Community Edition](https://shopware.com/en/download/) - PHP based open source e-commerce software made in Germany. [Source Code](https://github.com/shopware/shopware)) `Open Source AGPL v3` `PHP`
- [Shopware 6 Community Edition](https://shopware.com/en/download/) - PHP based open source e-commerce software made in Germany. ([Demo](https://shopwaredemo.store/), [Source Code](https://github.com/shopware/platform)) `MIT` `PHP`
