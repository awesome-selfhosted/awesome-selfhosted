...
- [Dim](https://github.com/Dusk-Labs/dim) - Dim, a media manager fueled by dark forces. Dim is a self-hosted media manager. With minimal setup, Dim will organize and beautify your media collections, letting you access and play them anytime from anywhere. `GPL-2.0` `Rust`
