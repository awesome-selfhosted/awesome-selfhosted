...
- [Send](https://gitlab.com/timvisee/send) - A file sharing experiment which allows you to send encrypted files to other users. [Client](https://gitlab.com/timvisee/send/-/tree/master/android) `MPL-2.0` `Nodejs`
