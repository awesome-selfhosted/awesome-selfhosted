...
- [OliveTin](https://github.com/jamesread/OliveTin) - OliveTin is a web interface for running Linux shell commands. ([Demo](https://www.youtube.com/watch?v=Ej6NM9rmZtk) ) `AGPL-3.0` `Go`
