...
**[`^        back to top        ^`](#)**
  ...
  * [SharpPaste](https://github.com/phonicmouse/SharpPaste) - A simple and cross-platform C# NancyFX/ASP.NET pastebin with client-side AES encryption that just works. ([Demo](https://sharppaste.nl/)) `MIT` `C#/ASP.NET`
