...
- [Klaxon](https://newsklaxon.org) - Klaxon enables reporters and editors to monitor scores of sites on the web for newsworthy changes. ([Source Code](https://github.com/themarshallproject/klaxon)) `MIT` `Ruby`
