...
- [FormKiQ Core](https://github.com/formkiq/formkiq-core) - A flexible Document Management Platform that can be used as headless software or run using our web-based client interface; it installs and runs in your Amazon Web Services (AWS) Cloud. `MIT` `Java/Nodejs`
