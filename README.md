...
- [URL Café](https://github.com/filasik/caffey_url) - URL Café is simple PHP URL shortener, with PWA support. No MySQL needed, only txt file. ([Demo](https://caffey.cz)) `PHP`
