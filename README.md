...
- [Umbrel](https://getumbrel.com/) - A beautiful personal server OS for Raspberry Pi or any Linux distro for running self-hosted apps, especially focusing on crypto. ([Source Code](https://github.com/getumbrel/umbrel)) `PolyForm Noncommercial License 1.0.0` `NodeJS/Docker`
