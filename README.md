...
- [Teampass](http://teampass.net/) - Password manager with a lot of functionality. Suitable for personal password but not safe for team usage. works on any server Apache, MySQL and PHP. ([Source Code](https://github.com/nilsteampassnet/TeamPass/)) `GPL-3.0` `PHP`
