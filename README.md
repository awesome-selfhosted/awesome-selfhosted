...
- [Firefox Sync Server](https://mozilla-services.readthedocs.io/en/latest/howtos/run-sync-1.5.html) - Sync Firefox bookmarks, passwords, history, tabs, preferences. `MPL-2.0` `Python`
