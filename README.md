...
- [Web Archiving Integration Layer (WAIL)](https://machawk1.github.io/wail/) - Self-hosted, preconfigured, institutional grade archival web crawler (Heritrix) and replay system (OpenWayback) bundled into a native application. ([Source Code](https://github.com/machawk1/wail)) `MIT` `Python`
