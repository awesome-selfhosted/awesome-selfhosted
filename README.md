...
- [cState](https://github.com/cstate/cstate/) - Static status page for hyperfast [Hugo](https://github.com/gohugoio/hugo/) w/ minimal JS, super light HTML/CSS, high customization, optional CMS, read-only API, and outstanding browser support (IE8+). Best used on platforms like Netlify or similar ones that support static generators. ([Demo](https://cstate.mnts.lt/)) `MIT` `Go`
