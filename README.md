...
- [homehost](https://github.com/ridhwaans/homehost) `⚠` - self-hosted React app that streams your media collection (music, movies, books, podcasts, comics etc)  `MIT` `Nodejs`
