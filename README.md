...
**[`^        back to top        ^`](#)**
  ...
  * [OwnTracks Recorder](https://github.com/owntracks/recorder) `⚠` - Store and access data published by [OwnTracks](http://owntracks.org/) location tracking apps. ([Source Code](https://github.com/owntracks/recorder)) `GPLv2` `C`/`Lua`
