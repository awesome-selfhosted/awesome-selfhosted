...
* [SpreeCommerce](https://spreecommerce.com/) - Spree is a complete open source e-commerce solution for Ruby on Rails. ([Source Code](https://github.com/spree/spree)) `BSD` `Ruby`
