...
- [IndiCom](https://github.com/balzack/databag) - Federated messaging client for the web, supporting text, images and video. ([Demo](https://databag.coredb.org/#/create)) `Apache-2.0` `Go`
