...
- [EmulatorJS](https://emulatorjs.netlify.app/) - Self-hosted Javascript emulation for various system.  ([Demo](https://emulatorjs.netlify.app/demo.html)) ([Source Code](https://github.com/EmulatorJS/EmulatorJS)) `GPL-3.0` `Nodejs`
