...
- [Memos](https://github.com/usememos/memos) - An open source, self-hosted knowledge base that works with a SQLite db file. ([Demo](https://memos.onrender.com/), [Source Code](https://github.com/usememos/memos)) `MIT` `Golang` `React`
