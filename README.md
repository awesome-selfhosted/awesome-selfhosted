...
- [Brick Breaker Game](https://github.com/dev-aniketj/Brick-Breaker-Game) - Brick Breaker Game is a Breakout clone which the player must smash a wall of bricks by deflecting a bouncing ball with a paddle. `Java`
