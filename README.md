...
- [MetaTube](https://github.com/JVT038/MetaTube) - A Web GUI to automatically download music from YouTube add metadata from Spotify, Deezer or Musicbrainz. ([Source Code](https://github.com/JVT038/MetaTube)) `GPL-3.0` `Python / JavaScript`
