...
- [MintHCM](https://minthcm.org/) - A professional tool for Human Capital Management. It's based on two popular, well-known business applications: SugarCRM Community Edition and SuiteCRM. ([Demo](https://minthcm.org/demo/) - requires sign-up, [Source Code](https://github.com/minthcm/minthcm)) `GPL-3.0` `PHP`
