...
- [VoceChat](https://voce.chat) - Private social sphere like Slack/Discord written with Rust. Host anywhere, embed anywhere. VoceChat is for you.  ([Demo](https://voce.chat)) `MIT` `Rust/Docker/Web/iOS/Android`
