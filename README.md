...
- [VPSTOOLBOX](https://github.com/johnrosen1/vpstoolbox) - Based on postfix dovecot and roundcubemail. ([Source Code](https://github.com/johnrosen1/vpstoolbox)) `MIT` `Shell`
