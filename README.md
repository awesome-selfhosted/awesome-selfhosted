...
- [Hellowlol HTPC Manager fork](https://github.com/Hellowlol/HTPC-Manager) - Fully responsive interface to manage all your favorite media on your HTPC. ([Source Code](https://github.com/Hellowlol/HTPC-Manager)) `MIT` `Python`
...
- [Open Build Service](https://openbuildservice.org) - Build and distribute Linux binary packages from sources in an automatic, consistent and reproducible way. ([Demo](https://build.opensuse.org/), [Source Code](https://github.com/openSUSE/open-build-service/)) `GPL-3.0-only` `Ruby On Rails / Perl`
