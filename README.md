...
- [Barrier](https://github.com/debauchee/barrier) - Barrier is software that mimics the functionality of a KVM switch for using a single keyboard/mouse with as many computers as you want. `GPL-1.0` `C/C++`
