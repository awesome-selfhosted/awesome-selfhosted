...
- [praul/autoreply](https://github.com/praul/autoreply) - A mail server independent out-of-office notice for multiple mail accounts. ([Source Code](https://github.com/praul/autoreply)) `CC0-1.0` `Python`
