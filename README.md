...
- [Cerbos](https://cerbos.dev/) - A self-hosted, open source user authorization layer for your applications. ([Source Code](https://github.com/cerbos/cerbos)) ([Demo](https://play.cerbos.dev)) `Apache-2.0` `Go`
