...
- [Scuttlebutt](https://www.scuttlebutt.nz) - a decent(ralised), asynchronous, peer-to-peer secure gossip platform, ([Getting Started](https://www.scuttlebutt.nz/getting-started), [Source Code](https://github.com/ssbc/)) `MIT` `Javascript`
