...
- [Fotrino](https://www.fotrino.com/) - Awesome photo gallery written in Python (Flask) and the Quasar framework.  Early stage development. ([Source Code](https://github.com/michaelmolino/fotrino-frontend)) `GPL-3.0` `Python`
