...
- [LernTools](https://lerntools.org/) - Tools for digital teaching with a focus on privacy. Components: ABCD-Quiz (comparable with Kahoot!), ideas (comparable with Padlet), survey ([Source Code](https://codeberg.org/lerntools/))  `GPL-3.0` `Javascript, Nodejs`
