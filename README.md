...
- [Sourcehut](https://sourcehut.org/) - A full web git interface with no javascript. ([Public Version](https://sr.ht/), [Source Code](https://git.sr.ht/~sircmpwn/git.sr.ht/tree)) `GLP-2` `Go`
