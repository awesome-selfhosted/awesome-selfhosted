...
**[`^        back to top        ^`](#)**
  ...
  * [Fider](http://getfider.com) - An open source alternative to UserVoice for customer feedback system . ([Demo](http://demo.fider.io), [Source Code](https://github.com/getfider/fider) `MIT` `Go`
