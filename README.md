...
- [Matomo](https://matomo.org/) - Leading open-source analytics platform that gives you more than just powerful analytics. ([Source Code](https://github.com/matomo-org/)) `GPL-3.0` `PHP`
