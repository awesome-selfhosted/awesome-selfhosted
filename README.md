...
**[`^        back to top        ^`](#)**
  ...
  * [LicAPI](https://projects.miguelpiedrafita.com/LicAPI) - A PHP API to manage license info ([Source Code](https://github.com/m1guelpf/LicAPI), [Demo](https://demo.miguelpiedrafita.com/LicAPI)) `Lic` `PHP`
