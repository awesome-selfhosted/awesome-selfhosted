...
- [Temporary chat](https://temporary.chat) - Temporary private chatrooms with file uploading support. Encrypted in transit. Can be deployed (ansible) with or without a domain name. ([Source Code](https://github.com/ba9f11ecc3497d9993b933fdc2bd61e5/temporary.chat-playbook)) `GPL-3.0` `Python`
