...
- [listmonk](https://listmonk.app/) - Self-hosted newsletter + mailing list manager: Performance and features packed into a single binary. ([Source Code](https://github.com/knadh/listmonk)) `AGPL-3.0` `Go`
