...
## Blogging Platforms
  ...
  * [Nikola](https://getnikola.com/) - Static Site Generator ([Source code](https://getnikola.com/index.src.html)) `MIT` `Python`
  * [Octopress](http://octopress.org/) - A blogging framework for hackers. ([Source code](https://github.com/imathis/octopress)) `MIT` `Ruby`
