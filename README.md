...
- [Laravel Shaarli](https://github.com/MarceauKa/laravel-shaarli) - All in one plateform for your links, stories and passwords. Built with Laravel and Vue.js. ([Demo](http://shaarli.mka.ovh/), [Source Code](https://github.com/MarceauKa/laravel-shaarli)) `MIT` `PHP`
