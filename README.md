...
- [LiveKit](https://livekit.io/) - Modern, scalable WebRTC conferencing platform with client SDKs. ([Source Code](https://github.com/livekit/livekit-server)) `Apache-2.0` `Go`
