...
- [euterpe](https://github.com/ironsmile/euterpe) - Self-hosted music streaming server notes with RESTful API and Web interface. Think of it as your very own Spotify! `GPL-3.0` `Go`
