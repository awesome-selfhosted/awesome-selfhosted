...
- [Dendron](https://www.dendron.so/) - Open source, local-first, Markdown editing and knowledge management in Visual Studio Code (VS Code) or VSCodium. Can also publish as a static site generator (SSG) with Next.js ([Source Code](https://github.com/dendronhq/dendron)) `AGPL-3.0` `TypeScript`
