...
- [SimpleX Chat](https://simplex.chat/) - The first chat platform that is 100% private by design - it has no access to your connection graph! ([Source Code](https://github.com/simplex-chat/simplex-chat)) `AGPL-3.0` `Haskell`
