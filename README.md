...
- [Navidrome](https://github.com/deluan/navidrome) - Multiplatform Music Collection Server and Streamer compatible with Subsonic/Airsonic. ([Source Code](https://github.com/deluan/navidrome)) `GPL-3.0` `Go`
