...
- [MoneyManagerEx](https://moneymanagerex.org/) - Money Manager Ex is a free, open-source, cross-platform, easy-to-use personal finance software. It primarily helps organize one's finances and keeps track of where, when and how the money goes. ([Source Code](https://github.com/moneymanagerex/moneymanagerex)) `GPL` `C++`
