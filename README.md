...
- [DailyNotes](https://github.com/m0ngr31/DailyNotes/) - App for taking notes and tracking tasks on a daily basis in Markdown. ([Source Code](https://github.com/m0ngr31/DailyNotes/)) `MIT` `Python`
