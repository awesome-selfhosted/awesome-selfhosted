...
- [Input-Leap](https://github.com/input-leap/input-leap) - Input-Leap is software that mimics the functionality of a KVM switch for using a single keyboard/mouse with as many computers as you want. `GPL-1.0` `C/C++`
