...
- [Digital-Currency](https://github.com/Icesofty/Digital-Currency) - Create your own Self-Hosted Digital Currency. ([Demo](http://64.227.62.141:3000), [Source Code](https://github.com/Icesofty/Digital-Currency)) `GPL-3.0` `Nodejs`
