...
- [qwantify](https://github.com/cmarincia/qwantify) - Open source docker image for running games (or other apps) on a shared host computer with at least one gpu. `Apache-2.0` `Go`
