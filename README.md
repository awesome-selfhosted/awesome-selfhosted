...
- [ioBroker](https://www.iobroker.net/) - ioBroker is an integration platform for the Internet of Things, focused on Building Automation, Smart Metering, Ambient Assisted Living, Process Automation, Visualization and Data Logging. ([Source Code](https://github.com/ioBroker/ioBroker)) `MIT` `Nodejs`
